...
/** 
  ...
  length byte array. Use {@link org.apache.lucene.index.DocsAndPositionsEnum#getPayload()} to retrieve the
  payloads from the index.
  
  <br><br>
  
  <p><b>NOTE:</b> As of 2.9, Token implements all {@link org.apache.lucene.util.Attribute} interfaces
  that are part of core Lucene and can be found in the {@code tokenattributes} subpackage.
  Even though it is not necessary to use Token anymore, with the new TokenStream API it can
  be used as convenience class that implements all {@link org.apache.lucene.util.Attribute}s, which is especially useful
...
public class Token extends CharTermAttributeImpl 
  ...
  /** <b>Expert:</b> Creates a TokenAttributeFactory returning {@link org.apache.lucene.analysis.Token} as instance for the basic attributes
  ...
  public static final class TokenAttributeFactory extends AttributeSource.AttributeFactory {
    ...
    /** <b>Expert</b>: Creates an AttributeFactory returning {@link org.apache.lucene.analysis.Token} as instance for the basic attributes
     * and for all other attributes calls the given delegate factory. */
