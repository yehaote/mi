 ...
 * {@link org.apache.lucene.analysis.Analyzer.TokenStreamComponents TokenStreamComponents} in {@link #createComponents(String, java.io.Reader)}.
 * The components are then reused in each call to {@link #tokenStream(String, java.io.Reader)}.
 * <p>
 * Simple example:
...
public abstract class Analyzer implements Closeable {
   ...
   * across calls to {@link #tokenStream(String, java.io.Reader)}.
   */
  public Analyzer() {
  ...
  /**
   * Expert: create a new Analyzer with a custom {@link org.apache.lucene.analysis.Analyzer.ReuseStrategy}.
   * <p>
   ...
   * <p>
   * This method uses {@link #createComponents(String, java.io.Reader)} to obtain an
   * instance of {@link org.apache.lucene.analysis.Analyzer.TokenStreamComponents}. It returns the sink of the
   * components and stores the components internally. Subsequent calls to this
   * method will reuse the previously stored components after resetting them
   * through {@link org.apache.lucene.analysis.Analyzer.TokenStreamComponents#setReader(java.io.Reader)}.
   * <p>
   ...
   * @throws org.apache.lucene.store.AlreadyClosedException if the Analyzer is closed.
   ...
   *
   * @param fieldName IndexableField name being indexed.
   * @return position increment gap, added to the next token emitted from {@link #tokenStream(String, java.io.Reader)}.
   ...
   * @return offset gap, added to the next token emitted from {@link #tokenStream(String, java.io.Reader)}.
   *         This value must be {@code >= 0}.
   */
   ...
   * {@link org.apache.lucene.analysis.Analyzer#tokenStream(String, java.io.Reader)}.
   */
  public static class TokenStreamComponents {
    ...
    /**
     * Creates a new {@link org.apache.lucene.analysis.Analyzer.TokenStreamComponents} instance.
     * 
     * @param source
     ...
     *           if the component's reset method throws an {@link java.io.IOException}
     */
  ...
  public static abstract class ReuseStrategy implements Closeable {
     ...
     * @throws org.apache.lucene.store.AlreadyClosedException if the ReuseStrategy is closed.
     */
  ...
  /**
   * Implementation of {@link org.apache.lucene.analysis.Analyzer.ReuseStrategy} that reuses the same components for
   * every field.
   */
  ...
  /**
   * Implementation of {@link org.apache.lucene.analysis.Analyzer.ReuseStrategy} that reuses components per-field by
