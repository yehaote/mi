...
/** A straightforward implementation of {@link org.apache.lucene.store.FSDirectory}
 *  using java.io.RandomAccessFile.  However, this class has
 *  poor concurrent performance (multiple threads will
 *  bottleneck) as it synchronizes when multiple threads
 *  read from the same file.  It's usually better to use
 *  {@link org.apache.lucene.store.NIOFSDirectory} or {@link org.apache.lucene.store.MMapDirectory} instead. */
public class SimpleFSDirectory extends FSDirectory {
  ...
  /**
   * Reads bytes with {@link java.io.RandomAccessFile#seek(long)} followed by
