 ...
 *       {@link java.util.concurrent.Future#cancel(boolean)} should use
...
public abstract class FSDirectory extends Directory {
  ...
  /** Just like {@link #open(java.io.File)}, but allows you to
   ...
   *   directory.
   *  @throws java.io.IOException if list() returns null */
   ...
   * underlying file during {@link org.apache.lucene.store.IndexInput#readBytes}.
   ...
   * already-opened {@link org.apache.lucene.store.IndexInput}s.  You should call
  ...
  /**
   * Writes output with {@link java.io.RandomAccessFile#write(byte[], int, int)}
   */
