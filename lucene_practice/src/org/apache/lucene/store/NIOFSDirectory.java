...
/**
 * An {@link org.apache.lucene.store.FSDirectory} implementation that uses java.nio's FileChannel's
 * positional read, which allows multiple threads to read from the same file
 * without synchronizing.
 * <p>
 * This class only uses FileChannel when reading; writing is achieved with
 * {@link org.apache.lucene.store.FSDirectory.FSIndexOutput}.
 * <p>
 ...
 * to {@link org.apache.lucene.store.NIOFSDirectory} will throw a {@link java.nio.channels.ClosedChannelException}. If
 * your application uses either {@link Thread#interrupt()} or
 * {@link java.util.concurrent.Future#cancel(boolean)} you should use {@link SimpleFSDirectory} in
 * favor of {@link org.apache.lucene.store.NIOFSDirectory}.</font>
 * </p>
 */
public class NIOFSDirectory extends FSDirectory {
  ...
  /**
   * Reads bytes with {@link java.nio.channels.FileChannel#read(java.nio.ByteBuffer, long)}
   */
