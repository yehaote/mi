...
/**
 * An AttributeSource contains a list of different {@link org.apache.lucene.util.AttributeImpl}s,
...
public class AttributeSource {
  /**
   * An AttributeFactory creates instances of {@link org.apache.lucene.util.AttributeImpl}s.
   */
  public static abstract class AttributeFactory {
    /**
     * returns an {@link org.apache.lucene.util.AttributeImpl} for the supplied {@link org.apache.lucene.util.Attribute} interface class.
     */
    public abstract AttributeImpl createAttributeInstance(Class<? extends Attribute> attClass);
    
    /**
     * This is the default factory that creates {@link org.apache.lucene.util.AttributeImpl}s using the
     * class name of the supplied {@link org.apache.lucene.util.Attribute} interface class by appending <code>Impl</code> to it.
     */
  ...
  /**
   * An AttributeSource using the default attribute factory {@link org.apache.lucene.util.AttributeSource.AttributeFactory#DEFAULT_ATTRIBUTE_FACTORY}.
   */
  ...
  /**
   * An AttributeSource using the supplied {@link org.apache.lucene.util.AttributeSource.AttributeFactory} for creating new {@link org.apache.lucene.util.Attribute} instances.
   */
   ...
   * The recommended way to use custom implementations is using an {@link org.apache.lucene.util.AttributeSource.AttributeFactory}.
   * </font></p>
   */
   ...
   * {@link org.apache.lucene.util.AttributeImpl#clear()} on each Attribute implementation.
   */
   ...
   * corresponding {@link org.apache.lucene.util.AttributeImpl#reflectWith} method.</p>
   *
   * @see org.apache.lucene.util.AttributeImpl#reflectWith
   */
  ...
  /**
   * Performs a clone of all {@link org.apache.lucene.util.AttributeImpl} instances returned in a new
   * {@code AttributeSource} instance. This method can be used to e.g. create another TokenStream
   * with exactly the same attributes (using {@link #AttributeSource(org.apache.lucene.util.AttributeSource)}).
   ...
   * The given instance has to provide all {@link org.apache.lucene.util.Attribute}s this instance contains.
   * The actual attribute implementations must be identical in both {@code AttributeSource} instances;
   * ideally both AttributeSource instances should use the same {@link org.apache.lucene.util.AttributeSource.AttributeFactory}.
