...
/**
 * {@link org.apache.lucene.util.BytesRefHash} is a special purpose hash-map like data-structure
 * optimized for {@link org.apache.lucene.util.BytesRef} instances. BytesRefHash maintains mappings of
 * byte arrays to ids (Map&lt;BytesRef,int&gt;) storing the hashed bytes
 * efficiently in continuous storage. The mapping to the id is
 * encapsulated inside {@link org.apache.lucene.util.BytesRefHash} and is guaranteed to be increased
 * for each added {@link org.apache.lucene.util.BytesRef}.
 * 
 * <p>
 * Note: The maximum capacity {@link org.apache.lucene.util.BytesRef} instance passed to
 * {@link #add(org.apache.lucene.util.BytesRef)} must not be longer than {@link ByteBlockPool#BYTE_BLOCK_SIZE}-2.
...
public final class BytesRefHash {
  ...
  /**
   * Creates a new {@link org.apache.lucene.util.BytesRefHash} with a {@link ByteBlockPool} using a
  ...
  /**
   * Creates a new {@link org.apache.lucene.util.BytesRefHash}
   */
  ...
  /**
   * Returns the number of {@link org.apache.lucene.util.BytesRef} values in this {@link org.apache.lucene.util.BytesRefHash}.
   * 
   * @return the number of {@link org.apache.lucene.util.BytesRef} values in this {@link org.apache.lucene.util.BytesRefHash}.
   */
  public int size() {
    return count;
  }
  ...
  /**
   * Populates and returns a {@link org.apache.lucene.util.BytesRef} with the bytes for the given
   * bytesID.
   * <p>
   ...
   *          the id
   * @param ref
   *          the {@link org.apache.lucene.util.BytesRef} to populate
   * 
   ...
   * order to reuse this {@link org.apache.lucene.util.BytesRefHash} instance.
   * </p>
   */
  int[] compact() {
    assert bytesStart != null : "bytesStart is null - not initialized";
   ...
   * 
   * @param comp
   *          the {@link java.util.Comparator} used for sorting
   */
  ...
  /**
   * Clears the {@link org.apache.lucene.util.BytesRef} which maps to the given {@link org.apache.lucene.util.BytesRef}
   */
  ...
  /**
   * Adds a new {@link org.apache.lucene.util.BytesRef}
   * 
   * @param bytes
   *          the bytes to hash
   ...
   * 
   * @throws org.apache.lucene.util.BytesRefHash.MaxBytesLengthExceededException
  ...
  /**
   * Adds a new {@link org.apache.lucene.util.BytesRef} with a pre-calculated hash code.
   * 
   * @param bytes
   *          the bytes to hash
   * @param code
  ...
  /**
   * Returns the id of the given {@link org.apache.lucene.util.BytesRef}.
   * 
   * @see #find(org.apache.lucene.util.BytesRef, int)
   */
  ...
  /**
   * Returns the id of the given {@link org.apache.lucene.util.BytesRef} with a pre-calculated hash code.
   * 
   * @param bytes
  ...
  /**
   * reinitializes the {@link org.apache.lucene.util.BytesRefHash} after a previous {@link #clear()}
  ...
  /**
   * Thrown if a {@link org.apache.lucene.util.BytesRef} exceeds the {@link org.apache.lucene.util.BytesRefHash} limit of
   * {@link ByteBlockPool#BYTE_BLOCK_SIZE}-2.
   */
  ...
  public abstract static class BytesStartArray {
    ...
    /**
     * Grows the {@link org.apache.lucene.util.BytesRefHash.BytesStartArray}
     * 
    ...
    /**
     * clears the {@link org.apache.lucene.util.BytesRefHash.BytesStartArray} and returns the cleared instance.
     * 
    ...
    /**
     * A {@link org.apache.lucene.util.Counter} reference holding the number of bytes used by this
     * {@link org.apache.lucene.util.BytesRefHash.BytesStartArray}. The {@link org.apache.lucene.util.BytesRefHash} uses this reference to
     * track it memory usage
     * 
     * @return a {@link java.util.concurrent.atomic.AtomicLong} reference holding the number of bytes used
     *         by this {@link org.apache.lucene.util.BytesRefHash.BytesStartArray}.
     */
    public abstract Counter bytesUsed();
  }

  /** A simple {@link org.apache.lucene.util.BytesRefHash.BytesStartArray} that tracks
   *  memory allocation using a private {@link java.util.concurrent.atomic.AtomicLong}
   *  instance.  */
