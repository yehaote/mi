...
public class PackedInts {
  ...
  public enum Format {
     ...
     * {@link org.apache.lucene.util.packed.PackedInts#fastestFormatAndBits(int, int, float)} to find the
  ...
  /**
   * Try to find the {@link org.apache.lucene.util.packed.PackedInts.Format} and number of bits per value that would
   ...
   * random-access {@link org.apache.lucene.util.packed.PackedInts.Reader}s. In case you only plan to perform
   * sequential access on this stream later on, you should probably use
   * {@link org.apache.lucene.util.packed.PackedInts#COMPACT}.
   * </p><p>
  ...
  /** A {@link org.apache.lucene.util.packed.PackedInts.Reader} which has all its values equal to 0 (bitsPerValue = 0). */
  ...
  /**
   * Get a {@link org.apache.lucene.util.packed.PackedInts.Decoder}.
   *
  ...
  /**
   * Get an {@link org.apache.lucene.util.packed.PackedInts.Encoder}.
   *
   * @param format         the format used to store packed ints
   * @param version        the compatibility version
   * @param bitsPerValue   the number of bits per value
  ...
  /**
   * Expert: Restore a {@link org.apache.lucene.util.packed.PackedInts.Reader} from a stream without reading metadata at
   * the beginning of the stream. This method is useful to restore data from
   * streams which have been created using
   * {@link org.apache.lucene.util.packed.PackedInts#getWriterNoHeader(DataOutput, org.apache.lucene.util.packed.PackedInts.Format, int, int, int)}.
   *
   ...
   * @see org.apache.lucene.util.packed.PackedInts#getWriterNoHeader(DataOutput, org.apache.lucene.util.packed.PackedInts.Format, int, int, int)
   * @lucene.internal
   */
  ...
  /**
   * Restore a {@link org.apache.lucene.util.packed.PackedInts.Reader} from a stream.
   *
  ...
  /**
   * Expert: Restore a {@link org.apache.lucene.util.packed.PackedInts.ReaderIterator} from a stream without reading
  ...
  /**
   * Retrieve PackedInts as a {@link org.apache.lucene.util.packed.PackedInts.ReaderIterator}
   * @param in positioned at the beginning of a stored packed int structure.
   * @param mem how much memory the iterator is allowed to use to read-ahead (likely to speed up iteration)
   * @return an iterator to access the values
   * @throws java.io.IOException if the structure could not be retrieved.
   * @lucene.internal
   */
  ...
  /**
   * Expert: Construct a direct {@link org.apache.lucene.util.packed.PackedInts.Reader} from a stream without reading
   * metadata at the beginning of the stream. This method is useful to restore
   * data from streams which have been created using
   * {@link org.apache.lucene.util.packed.PackedInts#getWriterNoHeader(DataOutput, org.apache.lucene.util.packed.PackedInts.Format, int, int, int)}.
   * </p><p>
   * The returned reader will have very little memory overhead, but every call
   * to {@link org.apache.lucene.util.packed.PackedInts.Reader#get(int)} is likely to perform a disk seek.
   *
   * @param in           the stream to read data from
   * @param format       the format used to serialize
   * @param version      the version used to serialize the data
  ...
  /**
   * Expert: Construct a direct {@link org.apache.lucene.util.packed.PackedInts.Reader} from an {@link IndexInput}
  ...
  /**
   * Construct a direct {@link org.apache.lucene.util.packed.PackedInts.Reader} from an {@link IndexInput}. This method
   * is useful to restore data from streams which have been created using
   * {@link org.apache.lucene.util.packed.PackedInts#getWriter(DataOutput, int, int, float)}.
   * </p><p>
   * The returned reader will have very little memory overhead, but every call
   * to {@link org.apache.lucene.util.packed.PackedInts.Reader#get(int)} is likely to perform a disk seek.
   *
   ...
   * {@link org.apache.lucene.util.packed.PackedInts#COMPACT} will make sure that the most memory-efficient
   * implementation is selected whereas {@link org.apache.lucene.util.packed.PackedInts#FASTEST} will make sure
   ...
   * <ul>
   *   <li><code>format</code> (using {@link org.apache.lucene.util.packed.PackedInts.Format#getId()}),</li>
   ...
   * {@link org.apache.lucene.util.packed.PackedInts.Writer#finish()}.
   * </p><p>
   ...
   * @return             a Writer
   * @see org.apache.lucene.util.packed.PackedInts#getReaderIteratorNoHeader(DataInput, org.apache.lucene.util.packed.PackedInts.Format, int, int, int, int)
   * @see org.apache.lucene.util.packed.PackedInts#getReaderNoHeader(DataInput, org.apache.lucene.util.packed.PackedInts.Format, int, int, int)
   * @lucene.internal
   */
   ...
   * sufficient to restore a {@link org.apache.lucene.util.packed.PackedInts.Reader} from it. You don't need to track
   * <code>valueCount</code> or <code>bitsPerValue</code> by yourself. In case
   * this is a problem, you should probably look at
   * {@link #getWriterNoHeader(DataOutput, org.apache.lucene.util.packed.PackedInts.Format, int, int, int)}.
   * </p><p>
   ...
   * {@link #getReaderNoHeader(DataInput, org.apache.lucene.util.packed.PackedInts.Header)}
   * or {@link #getDirectReaderNoHeader(IndexInput, org.apache.lucene.util.packed.PackedInts.Header)}.
   * @param    in the stream to read data
   * @return   packed integer metadata.
   * @throws   java.io.IOException If there is a low-level I/O error
   * @see #getReaderNoHeader(DataInput, org.apache.lucene.util.packed.PackedInts.Header)
   * @see #getDirectReaderNoHeader(IndexInput, org.apache.lucene.util.packed.PackedInts.Header)
   */
