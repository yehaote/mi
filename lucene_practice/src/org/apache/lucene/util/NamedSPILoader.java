...
public final class NamedSPILoader<S extends NamedSPILoader.NamedSPI> implements Iterable<S> {
  ...
  /**
   * Validates that a service name meets the requirements of {@link org.apache.lucene.util.NamedSPILoader.NamedSPI}
   */
  ...
  /**
   * Interface to support {@link org.apache.lucene.util.NamedSPILoader#lookup(String)} by name.
   * <p>
