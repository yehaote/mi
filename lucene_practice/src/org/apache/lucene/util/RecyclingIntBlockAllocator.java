...
/**
 * A {@link org.apache.lucene.util.IntBlockPool.Allocator} implementation that recycles unused int
...
public final class RecyclingIntBlockAllocator extends Allocator {
  ...
  /**
   * Creates a new {@link org.apache.lucene.util.RecyclingIntBlockAllocator}
   * 
   * @param blockSize
  ...
  /**
   * Creates a new {@link org.apache.lucene.util.RecyclingIntBlockAllocator} with a block size of
   * {@link org.apache.lucene.util.IntBlockPool#INT_BLOCK_SIZE}, upper buffered docs limit of
  ...
  /**
   * @return the number of bytes currently allocated by this {@link org.apache.lucene.util.IntBlockPool.Allocator}
   */
