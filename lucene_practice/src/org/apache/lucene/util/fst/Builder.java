...
public class Builder<T> {
   ...
   * to {@link #Builder(org.apache.lucene.util.fst.FST.INPUT_TYPE, int, int, boolean,
   * boolean, int, Outputs, org.apache.lucene.util.fst.Builder.FreezeTail, boolean, float,
   ...
   * 
   * @param inputType 
   *    The input type (transition labels). Can be anything from {@link org.apache.lucene.util.fst.FST.INPUT_TYPE}
   *    enumeration. Shorter types will consume less memory. Strings (character sequences) are 
   *    represented as {@link org.apache.lucene.util.fst.FST.INPUT_TYPE#BYTE4} (full unicode codepoints).
   *     
