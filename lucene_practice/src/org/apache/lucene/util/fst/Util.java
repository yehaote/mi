...
public final class Util {
  ...
  public static IntsRef getByOutput(FST<Long> fst, long targetOutput) throws IOException {
    ...
    Arc<Long> scratchArc = new Arc<Long>();
  ...
  /** 
   * Expert: like {@link org.apache.lucene.util.fst.Util#getByOutput(org.apache.lucene.util.fst.FST, long)} except reusing
  ...
  private static class FSTPath<T> {
    ...
    public FSTPath(T cost, Arc<T> arc, IntsRef input) {
  ...
  public static class TopNSearcher<T> {
    ...
    private final Arc<T> scratchArc = new Arc<T>();
    ...
    public void addStartPaths(Arc<T> node, T startOutput, boolean allowEmptyString, IntsRef input) throws IOException {
   ...
   *  PositiveIntOutputs#getSingleton}). */
  public static <T> MinResult<T>[] shortestPaths(FST<T> fst, Arc<T> fromNode, T startOutput, Comparator<T> comparator, int topN,
  ...
  /**
   * Dumps an {@link org.apache.lucene.util.fst.FST} to a GraphViz's <code>dot</code> language description
  ...
  public static <T> void toDot(FST<T> fst, Writer out, boolean sameRank, boolean labelStates) 
    ...
    final List<Arc<T>> thisLevelQueue = new ArrayList<Arc<T>>();

    // A queue of transitions to consider when processing the next level.
    final List<Arc<T>> nextLevelQueue = new ArrayList<Arc<T>>();
  ...
  */
   ...
   * @param in the fst's {@link org.apache.lucene.util.fst.FST.BytesReader}
   */
