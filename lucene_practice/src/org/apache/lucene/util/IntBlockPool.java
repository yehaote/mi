...
public final class IntBlockPool {
  ...
  /** A simple {@link org.apache.lucene.util.IntBlockPool.Allocator} that never recycles. */
  public static final class DirectAllocator extends Allocator {

    /**
     * Creates a new {@link org.apache.lucene.util.IntBlockPool.DirectAllocator} with a default block size
     */
  ...
  /**
   * Creates a new {@link org.apache.lucene.util.IntBlockPool} with a default {@link org.apache.lucene.util.IntBlockPool.Allocator}.
   * @see org.apache.lucene.util.IntBlockPool#nextBuffer()
   */
  public IntBlockPool() {
  ...
  /**
   * Creates a new {@link org.apache.lucene.util.IntBlockPool} with the given {@link org.apache.lucene.util.IntBlockPool.Allocator}.
   * @see org.apache.lucene.util.IntBlockPool#nextBuffer()
   */
   ...
   * {@link org.apache.lucene.util.IntBlockPool#nextBuffer()} is not needed after reset.
   */
  public void reset() {
   ...
   *        {@link org.apache.lucene.util.IntBlockPool.SliceWriter}.
   * @param reuseFirst if <code>true</code> the first buffer will be reused and calling
   *        {@link org.apache.lucene.util.IntBlockPool#nextBuffer()} is not needed after reset iff the
   *        block pool was used before ie. {@link org.apache.lucene.util.IntBlockPool#nextBuffer()} was called before.
   */
   ...
   * constructor a {@link org.apache.lucene.util.IntBlockPool#reset()} call will advance the pool to
   ...
   * @see org.apache.lucene.util.IntBlockPool.SliceReader
   */
  ...
  /**
   * An array holding the offset into the {@link org.apache.lucene.util.IntBlockPool#LEVEL_SIZE_ARRAY}
  ...
  /**
   * A {@link org.apache.lucene.util.IntBlockPool.SliceWriter} that allows to write multiple integer slices into a given {@link org.apache.lucene.util.IntBlockPool}.
   * 
   *  @see org.apache.lucene.util.IntBlockPool.SliceReader
   *  @lucene.internal
   */
  public static class SliceWriter {
     ...
     * should be used as the start offset to initialize a {@link org.apache.lucene.util.IntBlockPool.SliceReader}.
     */
     ...
     * should be used as the end offset to initialize a {@link org.apache.lucene.util.IntBlockPool.SliceReader} once
  ...
  /**
   * A {@link org.apache.lucene.util.IntBlockPool.SliceReader} that can read int slices written by a {@link org.apache.lucene.util.IntBlockPool.SliceWriter}
   * @lucene.internal
   */
  public static final class SliceReader {
    ...
    /**
     * Creates a new {@link org.apache.lucene.util.IntBlockPool.SliceReader} on the given pool
     */
     ...
     * method returns <code>true</code> {@link org.apache.lucene.util.IntBlockPool.SliceReader#readInt()} should not
     ...
     * @see org.apache.lucene.util.IntBlockPool.SliceReader#endOfSlice()
     */
    public int readInt() {
      assert !endOfSlice();
      assert upto <= limit;
