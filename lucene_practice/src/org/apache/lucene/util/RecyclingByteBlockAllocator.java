...
/**
 * A {@link org.apache.lucene.util.ByteBlockPool.Allocator} implementation that recycles unused byte
...
public final class RecyclingByteBlockAllocator extends Allocator {
  ...
  /**
   * Creates a new {@link org.apache.lucene.util.RecyclingByteBlockAllocator}
   * 
   * @param blockSize
   ...
   * @param bytesUsed
   *          {@link org.apache.lucene.util.Counter} reference counting internally allocated bytes
   */
  ...
  /**
   * Creates a new {@link org.apache.lucene.util.RecyclingByteBlockAllocator} with a block size of
   * {@link org.apache.lucene.util.ByteBlockPool#BYTE_BLOCK_SIZE}, upper buffered docs limit of
  ...
  /**
   * @return the number of bytes currently allocated by this {@link org.apache.lucene.util.ByteBlockPool.Allocator}
   */
