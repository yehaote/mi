 ...
 *   <p>In packed blocks, integers are encoded with the same bit width ({@link org.apache.lucene.util.packed.PackedInts packed format}):
 ...
 *   <p>In VInt blocks, integers are encoded as {@link org.apache.lucene.store.DataOutput#writeVInt VInt}:
 ...
 *   <li>PackedBlockSize, SingletonDocID --&gt; {@link org.apache.lucene.store.DataOutput#writeVInt VInt}</li>
 *   <li>DocFPDelta, PosFPDelta, PayFPDelta, PosVIntBlockFPDelta, SkipFPDelta --&gt; {@link org.apache.lucene.store.DataOutput#writeVLong VLong}</li>
 * </ul>
 * <p>Notes:</p>
 * <ul>
 ...
 *        a tradeoff. It is also the skip interval used to accelerate {@link org.apache.lucene.index.DocsEnum#advance(int)}.
 ...
 * omitted: {@link org.apache.lucene.index.FieldInfo.IndexOptions#DOCS_ONLY}). It also saves skip data to the beginning of
 ...
 *   <li>PackedDocDeltaBlock, PackedFreqBlock --&gt; {@link org.apache.lucene.util.packed.PackedInts PackedInts}</li>
 *   <li>DocDelta, Freq, DocSkip, DocFPSkip, PosFPSkip, PosBlockOffset, PayByteUpto, PayFPSkip 
 *       --&gt; 
 *   {@link org.apache.lucene.store.DataOutput#writeVInt VInt}</li>
 *   <li>SkipChildLevelPointer --&gt; {@link org.apache.lucene.store.DataOutput#writeVLong VLong}</li>
 * </ul>
 * <p>Notes:</p>
 * <ul>
 ...
 *       <p>15, 8, 3</p>
 *       <p>If frequencies were omitted ({@link org.apache.lucene.index.FieldInfo.IndexOptions#DOCS_ONLY}) it would be this
 ...
 *   <li>PackedPosDeltaBlock --&gt; {@link org.apache.lucene.util.packed.PackedInts PackedInts}</li>
 *   <li>PositionDelta, OffsetDelta, OffsetLength --&gt; 
 *       {@link org.apache.lucene.store.DataOutput#writeVInt VInt}</li>
 *   <li>PayloadData --&gt; {@link org.apache.lucene.store.DataOutput#writeByte byte}<sup>PayLength</sup></li>
 * </ul>
 * <p>Notes:</p>
 * <ul>
 ...
 *       {@link org.apache.lucene.index.FieldInfo.IndexOptions#DOCS_AND_FREQS_AND_POSITIONS_AND_OFFSETS}.</li>
 * </ul>
 * </dd>
 * </dl>
 *
 ...
 *   <li>PackedPayLengthBlock, PackedOffsetStartDeltaBlock, PackedOffsetLengthBlock --&gt; {@link org.apache.lucene.util.packed.PackedInts PackedInts}</li>
 *   <li>SumPayLength --&gt; {@link org.apache.lucene.store.DataOutput#writeVInt VInt}</li>
 *   <li>PayData --&gt; {@link org.apache.lucene.store.DataOutput#writeByte byte}<sup>SumPayLength</sup></li>
 * </ul>
 * <p>Notes:</p>
 * <ul>
...
public final class Lucene41PostingsFormat extends PostingsFormat {
   ...
   *  @see BlockTreeTermsWriter#BlockTreeTermsWriter(org.apache.lucene.index.SegmentWriteState,PostingsWriterBase,int,int) */
