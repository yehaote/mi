 ...
 *       by {@link FieldsConsumer#addField(org.apache.lucene.index.FieldInfo)}.
 *   <li>TermsConsumer returns a {@link PostingsConsumer} for
 *       each term in {@link #startTerm(org.apache.lucene.util.BytesRef)}.
 *   <li>When the producer (e.g. IndexWriter)
 *       is done adding documents for the term, it calls 
 *       {@link #finishTerm(org.apache.lucene.util.BytesRef, org.apache.lucene.codecs.TermStats)}, passing in
