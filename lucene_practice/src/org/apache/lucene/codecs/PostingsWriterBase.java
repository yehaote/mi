...
/**
 * Extension of {@link org.apache.lucene.codecs.PostingsConsumer} to support pluggable term dictionaries.
 * <p>
...
public abstract class PostingsWriterBase extends PostingsConsumer implements Closeable {
   ...
   *  #finishTerm(org.apache.lucene.codecs.TermStats)} is done, only if the term has at least one
   *  document. */
   ...
   *  org.apache.lucene.codecs.TermStats} contains the term's summary statistics. */
