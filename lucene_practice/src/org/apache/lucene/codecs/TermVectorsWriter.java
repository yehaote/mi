 ...
 *   <li>{@link #startField(org.apache.lucene.index.FieldInfo, int, boolean, boolean, boolean)} is called for
 ...
 *   <li>Within each field, {@link #startTerm(org.apache.lucene.util.BytesRef, int)} is called
 *       for each term.
 *   <li>If offsets and/or positions are enabled, then 
 *       {@link #addPosition(int, int, int, org.apache.lucene.util.BytesRef)} will be called for each term
 *       occurrence.
...
public abstract class TermVectorsWriter implements Closeable {
   ...
   *  {@link #startField(org.apache.lucene.index.FieldInfo, int, boolean, boolean, boolean)} will
   ...
   *  {@link #startTerm(org.apache.lucene.util.BytesRef, int)} will be called <code>numTerms</code> times. */
   ...
   * {@link #addPosition(int, int, int, org.apache.lucene.util.BytesRef)} will be called
   ...
   * <p>
   * The default implementation calls {@link #addPosition(int, int, int, org.apache.lucene.util.BytesRef)},
   ...
   *  {@link #startField(org.apache.lucene.index.FieldInfo, int, boolean, boolean, boolean)},
   *  {@link #startTerm(org.apache.lucene.util.BytesRef, int)}, {@link #addPosition(int, int, int, org.apache.lucene.util.BytesRef)},
   *  and {@link #finish(org.apache.lucene.index.FieldInfos, int)},
