 ...
 * <p>
 * Very similarly to {@link org.apache.lucene.codecs.lucene41.Lucene41StoredFieldsFormat}, this format is based
 ...
 * {@link org.apache.lucene.util.packed.PackedInts packed ints}.
 * </ul>
 * <p>
 ...
 * {@link org.apache.lucene.util.packed.BlockPackedWriter blocks of packed ints} for positions.</p>
 * <p>Here is a more detailed description of the field data file format:</p>
 * <ul>
 * <li>VectorData (.tvd) --&gt; &lt;Header&gt;, PackedIntsVersion, ChunkSize, &lt;Chunk&gt;<sup>ChunkCount</sup></li>
 * <li>Header --&gt; {@link CodecUtil#writeHeader CodecHeader}</li>
 * <li>PackedIntsVersion --&gt; {@link org.apache.lucene.util.packed.PackedInts#VERSION_CURRENT} as a {@link org.apache.lucene.store.DataOutput#writeVInt VInt}</li>
 * <li>ChunkSize is the number of bytes of terms to accumulate before flushing, as a {@link org.apache.lucene.store.DataOutput#writeVInt VInt}</li>
 ...
 * <li>DocBase is the ID of the first doc of the chunk as a {@link org.apache.lucene.store.DataOutput#writeVInt VInt}</li>
 * <li>ChunkDocs is the number of documents in the chunk</li>
 * <li>NumFields --&gt; DocNumFields<sup>ChunkDocs</sup></li>
 * <li>DocNumFields is the number of fields for each doc, written as a {@link org.apache.lucene.store.DataOutput#writeVInt VInt} if ChunkDocs==1 and as a {@link org.apache.lucene.util.packed.PackedInts} array otherwise</li>
 ...
 * <li>FieldNumOffs --&gt; FieldNumOff<sup>TotalFields</sup>, as a {@link org.apache.lucene.util.packed.PackedInts} array</li>
 ...
 * <li>FieldNumTerms: the number of terms for each field, using {@link org.apache.lucene.util.packed.BlockPackedWriter blocks of 64 packed ints}</li>
 ...
 * <li>PrefixLength: 0 for the first term of a field, the common prefix with the previous term otherwise using {@link org.apache.lucene.util.packed.BlockPackedWriter blocks of 64 packed ints}</li>
 * <li>SuffixLength: length of the term minus PrefixLength for every term using {@link org.apache.lucene.util.packed.BlockPackedWriter blocks of 64 packed ints}</li>
 * <li>TermFreqs --&gt; TermFreqMinus1<sup>TotalTerms</sup></li>
 * <li>TermFreqMinus1: (frequency - 1) for each term using  {@link org.apache.lucene.util.packed.BlockPackedWriter blocks of 64 packed ints}</li>
 ...
 * <li>PositionDelta: the absolute position for the first position of a term, and the difference with the previous positions for following positions using {@link org.apache.lucene.util.packed.BlockPackedWriter blocks of 64 packed ints}</li>
 ...
 * <li>StartOffsetDelta: (startOffset - previousStartOffset - AvgCharsPerTerm * PositionDelta). previousStartOffset is 0 for the first offset and AvgCharsPerTerm is 0 if the field has no positions using  {@link org.apache.lucene.util.packed.BlockPackedWriter blocks of 64 packed ints}</li>
 * <li>Lengths --&gt; LengthMinusTermLength<sup>TotalOffsets</sup></li>
 * <li>LengthMinusTermLength: (endOffset - startOffset - termLength) using  {@link org.apache.lucene.util.packed.BlockPackedWriter blocks of 64 packed ints}</li>
 ...
 * <li>PayloadLength is the payload length encoded using  {@link org.apache.lucene.util.packed.BlockPackedWriter blocks of 64 packed ints}</li>
