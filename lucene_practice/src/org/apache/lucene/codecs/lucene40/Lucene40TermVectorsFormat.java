 ...
 *   <li>DocumentPosition --&gt; {@link org.apache.lucene.store.DataOutput#writeLong UInt64} (offset in the .tvd file)</li>
 *   <li>FieldPosition --&gt; {@link org.apache.lucene.store.DataOutput#writeLong UInt64} (offset in the .tvf file)</li>
 * </ul>
 * </li>
 ...
 * <ul>
 *   <li>Header --&gt; {@link CodecUtil#writeHeader CodecHeader}</li>
 *   <li>NumFields --&gt; {@link org.apache.lucene.store.DataOutput#writeVInt VInt}</li>
 *   <li>FieldNums --&gt; &lt;FieldNumDelta&gt; <sup>NumFields</sup></li>
 *   <li>FieldNumDelta --&gt; {@link org.apache.lucene.store.DataOutput#writeVInt VInt}</li>
 *   <li>FieldPositions --&gt; &lt;FieldPositionDelta&gt; <sup>NumFields-1</sup></li>
 *   <li>FieldPositionDelta --&gt; {@link org.apache.lucene.store.DataOutput#writeVLong VLong}</li>
 * </ul>
 * </li>
 ...
 * <ul>
 *   <li>Header --&gt; {@link CodecUtil#writeHeader CodecHeader}</li>
 *   <li>NumTerms --&gt; {@link org.apache.lucene.store.DataOutput#writeVInt VInt}</li>
 *   <li>Flags --&gt; {@link org.apache.lucene.store.DataOutput#writeByte Byte}</li>
 *   <li>TermFreqs --&gt; &lt;TermText, TermFreq, Positions?, PayloadData?, Offsets?&gt;
 *       <sup>NumTerms</sup></li>
 *   <li>TermText --&gt; &lt;PrefixLength, Suffix&gt;</li>
 *   <li>PrefixLength --&gt; {@link org.apache.lucene.store.DataOutput#writeVInt VInt}</li>
 *   <li>Suffix --&gt; {@link org.apache.lucene.store.DataOutput#writeString String}</li>
 *   <li>TermFreq --&gt; {@link org.apache.lucene.store.DataOutput#writeVInt VInt}</li>
 *   <li>Positions --&gt; &lt;PositionDelta PayloadLength?&gt;<sup>TermFreq</sup></li>
 *   <li>PositionDelta --&gt; {@link org.apache.lucene.store.DataOutput#writeVInt VInt}</li>
 *   <li>PayloadLength --&gt; {@link org.apache.lucene.store.DataOutput#writeVInt VInt}</li>
 *   <li>PayloadData --&gt; {@link org.apache.lucene.store.DataOutput#writeByte Byte}<sup>NumPayloadBytes</sup></li>
 *   <li>Offsets --&gt; &lt;{@link org.apache.lucene.store.DataOutput#writeVInt VInt}, {@link org.apache.lucene.store.DataOutput#writeVInt VInt}&gt;<sup>TermFreq</sup></li>
 * </ul>
 * <p>Notes:</p>
 * <ul>
