 ...
 * Files:
 * <ul>
 *   <li><tt>.dv.cfs</tt>: {@link org.apache.lucene.store.CompoundFileDirectory compound container}</li>
 *   <li><tt>.dv.cfe</tt>: {@link org.apache.lucene.store.CompoundFileDirectory compound entries}</li>
 * </ul>
 ...
 *        {@link org.apache.lucene.store.DataOutput#writeByte Byte}<sup>maxdoc</sup></li>
 *    <li>{@code FIXED_INTS_16} .dat --&gt; Header, ValueSize,
 *        {@link org.apache.lucene.store.DataOutput#writeShort Short}<sup>maxdoc</sup></li>
 *    <li>{@code FIXED_INTS_32} .dat --&gt; Header, ValueSize,
 *        {@link org.apache.lucene.store.DataOutput#writeInt Int32}<sup>maxdoc</sup></li>
 *    <li>{@code FIXED_INTS_64} .dat --&gt; Header, ValueSize,
 *        {@link org.apache.lucene.store.DataOutput#writeLong Int64}<sup>maxdoc</sup></li>
 ...
 *        ({@link org.apache.lucene.store.DataOutput#writeByte Byte} * ValueSize)<sup>maxdoc</sup></li>
 *    <li>{@code BYTES_VAR_STRAIGHT} .idx --&gt; Header, TotalBytes, Addresses</li>
 *    <li>{@code BYTES_VAR_STRAIGHT} .dat --&gt; Header,
          ({@link org.apache.lucene.store.DataOutput#writeByte Byte} * <i>variable ValueSize</i>)<sup>maxdoc</sup></li>
 *    <li>{@code BYTES_FIXED_DEREF} .idx --&gt; Header, NumValues, Addresses</li>
 *    <li>{@code BYTES_FIXED_DEREF} .dat --&gt; Header, ValueSize,
 *        ({@link org.apache.lucene.store.DataOutput#writeByte Byte} * ValueSize)<sup>NumValues</sup></li>
 *    <li>{@code BYTES_VAR_DEREF} .idx --&gt; Header, TotalVarBytes, Addresses</li>
 *    <li>{@code BYTES_VAR_DEREF} .dat --&gt; Header,
 *        (LengthPrefix + {@link org.apache.lucene.store.DataOutput#writeByte Byte} * <i>variable ValueSize</i>)<sup>NumValues</sup></li>
 ...
 *        ({@link org.apache.lucene.store.DataOutput#writeByte Byte} * <i>variable ValueSize</i>)<sup>NumValues</sup></li>
 * </ul>
 * Data Types:
 * <ul>
 *    <li>Header --&gt; {@link CodecUtil#writeHeader CodecHeader}</li>
 *    <li>PackedType --&gt; {@link org.apache.lucene.store.DataOutput#writeByte Byte}</li>
 *    <li>MaxAddress, MinValue, DefaultValue --&gt; {@link org.apache.lucene.store.DataOutput#writeLong Int64}</li>
 *    <li>PackedStream, Addresses, Ordinals --&gt; {@link org.apache.lucene.util.packed.PackedInts}</li>
 *    <li>ValueSize, NumValues --&gt; {@link org.apache.lucene.store.DataOutput#writeInt Int32}</li>
 *    <li>Float32 --&gt; 32-bit float encoded with {@link Float#floatToRawIntBits(float)}
 *                       then written as {@link org.apache.lucene.store.DataOutput#writeInt Int32}</li>
 *    <li>Float64 --&gt; 64-bit float encoded with {@link Double#doubleToRawLongBits(double)}
 *                       then written as {@link org.apache.lucene.store.DataOutput#writeLong Int64}</li>
 *    <li>TotalBytes --&gt; {@link org.apache.lucene.store.DataOutput#writeVLong VLong}</li>
 *    <li>TotalVarBytes --&gt; {@link org.apache.lucene.store.DataOutput#writeLong Int64}</li>
 *    <li>LengthPrefix --&gt; Length of the data value as {@link org.apache.lucene.store.DataOutput#writeVInt VInt} (maximum
 *                       of 2 bytes)</li>
 * </ul>
 * Notes:
 * <ul>
 ...
 *        is encoded as a prefix to the data itself as a {@link org.apache.lucene.store.DataOutput#writeVInt VInt}
