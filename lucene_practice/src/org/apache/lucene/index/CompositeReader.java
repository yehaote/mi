...
/**
 ...
 Alternatively, you can mimic an {@link org.apache.lucene.index.AtomicReader} (with a serious slowdown),
...
public abstract class CompositeReader extends IndexReader {
   ...
   *  is no longer public, code that wants to get all {@link org.apache.lucene.index.AtomicReader}s
   *  this composite is composed of should use {@link org.apache.lucene.index.IndexReader#leaves()}.
   * @see org.apache.lucene.index.IndexReader#leaves()
   */
