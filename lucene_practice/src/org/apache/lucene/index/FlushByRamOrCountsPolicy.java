...
/**
 * Default {@link org.apache.lucene.index.FlushPolicy} implementation that flushes based on RAM used,
 ...
 * {@link org.apache.lucene.index.IndexWriterConfig#getMaxBufferedDeleteTerms()} is enabled</li>
 * <li>{@link #onInsert(DocumentsWriterFlushControl, DocumentsWriterPerThreadPool.ThreadState)} - flushes
 * either on the number of documents per {@link org.apache.lucene.index.DocumentsWriterPerThread} (
 * {@link org.apache.lucene.index.DocumentsWriterPerThread#getNumDocsInRAM()}) or on the global active
 * memory consumption in the current indexing session iff
 * {@link org.apache.lucene.index.IndexWriterConfig#getMaxBufferedDocs()} or
 * {@link org.apache.lucene.index.IndexWriterConfig#getRAMBufferSizeMB()} is enabled respectively</li>
 ...
 * </ul>
 * All {@link org.apache.lucene.index.IndexWriterConfig} settings are used to mark
 * {@link org.apache.lucene.index.DocumentsWriterPerThread} as flush pending during indexing with
 * respect to their live updates.
 * <p>
 * If {@link org.apache.lucene.index.IndexWriterConfig#setRAMBufferSizeMB(double)} is enabled, the
 * largest ram consuming {@link org.apache.lucene.index.DocumentsWriterPerThread} will be marked as
...
class FlushByRamOrCountsPolicy extends FlushPolicy {
  ...
  /**
   * Marks the most ram consuming active {@link org.apache.lucene.index.DocumentsWriterPerThread} flush
   * pending
   */
  ...
  /**
   * Returns <code>true</code> if this {@link org.apache.lucene.index.FlushPolicy} flushes on
   * {@link org.apache.lucene.index.IndexWriterConfig#getMaxBufferedDocs()}, otherwise
   * <code>false</code>.
   */
  ...
  /**
   * Returns <code>true</code> if this {@link org.apache.lucene.index.FlushPolicy} flushes on
   * {@link org.apache.lucene.index.IndexWriterConfig#getMaxBufferedDeleteTerms()}, otherwise
   * <code>false</code>.
   */
  ...
  /**
   * Returns <code>true</code> if this {@link org.apache.lucene.index.FlushPolicy} flushes on
   * {@link org.apache.lucene.index.IndexWriterConfig#getRAMBufferSizeMB()}, otherwise
   * <code>false</code>.
   */
