...
/**
 * Holds all the configuration used by {@link org.apache.lucene.index.IndexWriter} with few setters for
 * settings that can be changed on an {@link org.apache.lucene.index.IndexWriter} instance "live".
 * 
 * @since 4.0
 */
public class LiveIndexWriterConfig {
  ...
  /** {@link org.apache.lucene.index.IndexDeletionPolicy} controlling when commit
   *  points are deleted. */
  protected volatile IndexDeletionPolicy delPolicy;

  /** {@link org.apache.lucene.index.IndexCommit} that {@link org.apache.lucene.index.IndexWriter} is
   *  opened on. */
  protected volatile IndexCommit commit;

  /** {@link org.apache.lucene.index.IndexWriterConfig.OpenMode} that {@link org.apache.lucene.index.IndexWriter} is opened
   *  with. */
  ...
  /** {@link org.apache.lucene.index.MergeScheduler} to use for running merges. */
  ...
  /** {@link org.apache.lucene.util.InfoStream} for debugging messages. */
  protected volatile InfoStream infoStream;

  /** {@link org.apache.lucene.index.MergePolicy} for selecting merges. */
  ...
  /** {@link org.apache.lucene.index.FlushPolicy} to control when segments are
   *  flushed. */
  ...
  /** {@link org.apache.lucene.util.Version} that {@link org.apache.lucene.index.IndexWriter} should emulate. */
  ...
  /**
   * Creates a new config that that handles the live {@link org.apache.lucene.index.IndexWriter}
   * settings.
   */
   ...
   * 
   * @see org.apache.lucene.index.IndexWriterConfig#DEFAULT_TERM_INDEX_INTERVAL
   */
   ...
   * {@link org.apache.lucene.index.IndexWriterConfig#DISABLE_AUTO_FLUSH} to prevent triggering a flush
   ...
   * memory. Yet, an {@link org.apache.lucene.index.IndexWriter} session can consume a significantly
   ...
   * {@link org.apache.lucene.index.FlushPolicy} only a subset of the buffered documents are flushed and
   * therefore only parts of the RAM buffer is released.
   * <p>
   * 
   * The default value is {@link org.apache.lucene.index.IndexWriterConfig#DEFAULT_RAM_BUFFER_SIZE_MB}.
   * 
   * <p>
   * Takes effect immediately, but only the next time a document is added,
   * updated or deleted.
   * 
   * @see org.apache.lucene.index.IndexWriterConfig#setRAMPerThreadHardLimitMB(int)
   * 
   * @throws IllegalArgumentException
   ...
   * documents. Pass in {@link org.apache.lucene.index.IndexWriterConfig#DISABLE_AUTO_FLUSH} to prevent
  ...
  /**
   * Set the merged segment warmer. See {@link org.apache.lucene.index.IndexWriter.IndexReaderWarmer}.
   * 
   * <p>
  ...
  /** Returns the current merged segment warmer. See {@link org.apache.lucene.index.IndexWriter.IndexReaderWarmer}. */
   ...
   * {@link org.apache.lucene.index.DirectoryReader#open(org.apache.lucene.index.IndexWriter, boolean)}. If you pass -1, the
  ...
  /** Returns the {@link org.apache.lucene.index.IndexWriterConfig.OpenMode} set by {@link org.apache.lucene.index.IndexWriterConfig#setOpenMode(org.apache.lucene.index.IndexWriterConfig.OpenMode)}. */
  public OpenMode getOpenMode() {
    return openMode;
  }
  
  /**
   * Returns the {@link org.apache.lucene.index.IndexDeletionPolicy} specified in
   * {@link org.apache.lucene.index.IndexWriterConfig#setIndexDeletionPolicy(org.apache.lucene.index.IndexDeletionPolicy)} or
  ...
  /**
   * Returns the {@link org.apache.lucene.index.IndexCommit} as specified in
   * {@link org.apache.lucene.index.IndexWriterConfig#setIndexCommit(org.apache.lucene.index.IndexCommit)} or the default,
  ...
  /**
   * Returns the {@link org.apache.lucene.index.MergeScheduler} that was set by
   * {@link org.apache.lucene.index.IndexWriterConfig#setMergeScheduler(org.apache.lucene.index.MergeScheduler)}.
   */
   ...
   *
   * @see org.apache.lucene.index.IndexWriterConfig#setWriteLockTimeout(long)
   */
   ...
   *
   * @see org.apache.lucene.index.IndexWriterConfig#setMergePolicy(org.apache.lucene.index.MergePolicy)
   */
   ...
   * 
   * @see org.apache.lucene.index.IndexWriterConfig#setIndexerThreadPool(DocumentsWriterPerThreadPool)
  ...
  /**
   * Returns {@code true} if {@link org.apache.lucene.index.IndexWriter} should pool readers even if
   * {@link org.apache.lucene.index.DirectoryReader#open(org.apache.lucene.index.IndexWriter, boolean)} has not been called.
   */
   ...
   * {@link org.apache.lucene.index.IndexWriterConfig#setIndexingChain(IndexingChain)}.
   */
  ...
  /**
   * @see org.apache.lucene.index.IndexWriterConfig#setFlushPolicy(org.apache.lucene.index.FlushPolicy)
   */
  FlushPolicy getFlushPolicy() {
    return flushPolicy;
  }
  
  /** Returns {@link org.apache.lucene.util.InfoStream} used for debugging.
   *
