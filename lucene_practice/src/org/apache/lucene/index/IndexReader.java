...
public abstract class IndexReader implements Closeable {
  ...
  public static interface ReaderClosedListener {
    /** Invoked when the {@link org.apache.lucene.index.IndexReader} is closed. */
  ...
  /** Expert: adds a {@link org.apache.lucene.index.IndexReader.ReaderClosedListener}.  The
  ...
  /** Expert: remove a previously added {@link org.apache.lucene.index.IndexReader.ReaderClosedListener}.
   *
   * @lucene.experimental */
   ...
   * is unchanged.
   *
   * @throws java.io.IOException in case an IOException occurs in  doClose()
   *
   * @see #incRef
   */
   ...
   * @throws java.io.IOException if there is a low-level IO error
   * @deprecated Use {@link DirectoryReader#open(org.apache.lucene.index.IndexCommit)}
   */
  @Deprecated
   ...
   *  to -1 to skip loading the terms index entirely.
   * @throws java.io.IOException if there is a low-level IO error
   * @deprecated Use {@link DirectoryReader#open(org.apache.lucene.index.IndexCommit,int)}
   */
  @Deprecated
   ...
   * org.apache.lucene.util.Bits} returned from {@link MultiFields#getLiveDocs}.
   *
   ...
   * DocumentStoredFieldVisitor#DocumentStoredFieldVisitor(java.util.Set)}.
   */
   ...
   * {@link org.apache.lucene.index.IndexReader}'s sub-reader tree.
   * <p>
   ...
   * away. 
   * @see org.apache.lucene.index.TermsEnum#docFreq()
   */
   ...
   * @see org.apache.lucene.index.TermsEnum#totalTermFreq()
   */
  public abstract long totalTermFreq(Term term) throws IOException;
  
  /**
   * Returns the sum of {@link org.apache.lucene.index.TermsEnum#docFreq()} for all terms in this field,
  ...
  /**
   * Returns the sum of {@link org.apache.lucene.index.TermsEnum#totalTermFreq} for all terms in this
