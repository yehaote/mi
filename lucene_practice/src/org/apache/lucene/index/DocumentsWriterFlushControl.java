...
/**
 * This class controls {@link org.apache.lucene.index.DocumentsWriterPerThread} flushing during
 * indexing. It tracks the memory consumption per
 * {@link org.apache.lucene.index.DocumentsWriterPerThread} and uses a configured {@link org.apache.lucene.index.FlushPolicy} to
 * decide if a {@link org.apache.lucene.index.DocumentsWriterPerThread} must flush.
 * <p>
 * In addition to the {@link org.apache.lucene.index.FlushPolicy} the flush control might set certain
 * {@link org.apache.lucene.index.DocumentsWriterPerThread} as flush pending iff a
 * {@link org.apache.lucene.index.DocumentsWriterPerThread} exceeds the
 * {@link org.apache.lucene.index.IndexWriterConfig#getRAMPerThreadHardLimitMB()} to prevent address
 * space exhaustion.
 */
