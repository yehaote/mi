...
/**
  ...
  * and triggers the upgrade via an forceMerge request to {@link org.apache.lucene.index.IndexWriter}.
  ...
  * {@link #IndexUpgrader(Directory, org.apache.lucene.util.Version, java.io.PrintStream,boolean)}.
  ...
  * The {@link org.apache.lucene.index.MergePolicy} set by {@link IndexWriterConfig} may also reorder
  * documents.
  */
public final class IndexUpgrader {
  ...
  /** Creates index upgrader on the given directory, using an {@link org.apache.lucene.index.IndexWriter} using the given
