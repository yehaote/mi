...
/** An {@link org.apache.lucene.index.CompositeReader} which reads multiple, parallel indexes.  Each index added
 ...
 * A good strategy to create suitable indexes with {@link org.apache.lucene.index.IndexWriter} is to use
 * {@link org.apache.lucene.index.LogDocMergePolicy}, as this one does not reorder documents
 * during merging (like {@code TieredMergePolicy}) and triggers merges
 * by number of documents per segment. If you use different {@link org.apache.lucene.index.MergePolicy}s
