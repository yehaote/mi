...
/** Base class for implementing {@link org.apache.lucene.index.CompositeReader}s based on an array
 * of sub-readers. The implementing class has to add code for
 * correctly refcounting and closing the sub-readers.
 * 
 * <p>User code will most likely use {@link org.apache.lucene.index.MultiReader} to build a
 * composite reader on a set of sub-readers (like several
 * {@link org.apache.lucene.index.DirectoryReader}s).
 * 
 ...
 * @see org.apache.lucene.index.MultiReader
 * @lucene.internal
 */
