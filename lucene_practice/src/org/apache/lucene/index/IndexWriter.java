...
/**
  ...
  #updateDocument(org.apache.lucene.index.Term, Iterable) updateDocument} (which just deletes
  ...
  org.apache.lucene.index.IndexWriter} instances are completely thread
  ...
  the unchecked exception {@link org.apache.lucene.util.ThreadInterruptedException}
...
public class IndexWriter implements Closeable, TwoPhaseCommit {
  ...
  /** Source of a segment which results from a call to {@link #addIndexes(org.apache.lucene.index.IndexReader...)}. */
   ...
   *
   * <p>You must close the {@link org.apache.lucene.index.IndexReader} returned by
   ...
   *  DirectoryReader#open(org.apache.lucene.index.IndexWriter,boolean)}).  If the
   ...
   *  (e.g., {@link #deleteDocuments(org.apache.lucene.index.Term)}). */
  ...
  */
   ...
   *  {@link org.apache.lucene.index.IndexReader#numDeletedDocs}.</p>
   *
   ...
   *    #forceMerge}, {@link #addIndexes(org.apache.lucene.index.IndexReader[])} or
   ...
   * 
   * <p>
   * <b>NOTE:</b> this method merges all given {@link org.apache.lucene.index.IndexReader}s in one
  ...
  public void addIndexes(IndexReader... readers) throws IOException {
    ...
    try {
      ...
      SegmentMerger merger = new SegmentMerger(mergeReaders, info, infoStream, trackingDir, config.getTermIndexInterval(),
                                               CheckAbort.NONE, globalFieldNumberMap, context);
   ...
   * {@link org.apache.lucene.index.IndexWriter} and will be {@link #commit() committed} even if no other
   ...
   * was set on {@link #setCommitData(java.util.Map)}.
   */
  ...
  private int mergeMiddle(MergePolicy.OneMerge merge) throws IOException {
    ...
    final CheckAbort checkAbort = new CheckAbort(merge, directory);
  ...
  /** If {@link DirectoryReader#open(org.apache.lucene.index.IndexWriter,boolean)} has
   ...
   * @see IndexFileDeleter#deleteNewFiles(java.util.Collection)
   */
