...
/**
 * A {@link org.apache.lucene.index.SnapshotDeletionPolicy} which adds a persistence layer so that
 ...
 * class for safety (it will close the {@link org.apache.lucene.index.IndexWriter} instance used).
 * <p>
 * <b>NOTE:</b> Sharing {@link org.apache.lucene.index.PersistentSnapshotDeletionPolicy}s that write to
 * the same directory across {@link org.apache.lucene.index.IndexWriter}s will corrupt snapshots. You
 * should make sure every {@link org.apache.lucene.index.IndexWriter} has its own
 * {@link org.apache.lucene.index.PersistentSnapshotDeletionPolicy} and that they all write to a
...
public class PersistentSnapshotDeletionPolicy extends SnapshotDeletionPolicy implements Closeable {
  ...
  /**
   * {@link org.apache.lucene.index.PersistentSnapshotDeletionPolicy} wraps another
   * {@link org.apache.lucene.index.IndexDeletionPolicy} to enable flexible snapshotting.
   * 
   * @param primary
   ...
   * @param matchVersion
   *          specifies the {@link org.apache.lucene.util.Version} that should be used when opening the
   *          IndexWriter.
   */
   ...
   * 
   * @see org.apache.lucene.index.SnapshotDeletionPolicy#snapshot(String)
   */
  @Override
   ...
   * 
   * @see org.apache.lucene.index.SnapshotDeletionPolicy#release(String)
   */
  @Override
