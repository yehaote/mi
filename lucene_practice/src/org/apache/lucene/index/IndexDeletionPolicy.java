...
/**
 * <p>Expert: policy for deletion of stale {@link org.apache.lucene.index.IndexCommit index commits}.
 * 
 * <p>Implement this interface, and pass it to one
 * of the {@link org.apache.lucene.index.IndexWriter} or {@link org.apache.lucene.index.IndexReader}
 * constructors, to customize when older
 * {@link org.apache.lucene.index.IndexCommit point-in-time commits}
 ...
 * refresh to the new commit before {@link org.apache.lucene.index.IndexWriter}
...
public abstract class IndexDeletionPolicy implements Cloneable {
   ...
   * calling method {@link org.apache.lucene.index.IndexCommit#delete delete()}
   * of {@link org.apache.lucene.index.IndexCommit}.</p>
   * 
   ...
   * by calling method {@link org.apache.lucene.index.IndexCommit#delete delete()}
   * of {@link org.apache.lucene.index.IndexCommit}.</p>
   * 
   * <p>This method is only called when {@link
   * org.apache.lucene.index.IndexWriter#commit} or {@link org.apache.lucene.index.IndexWriter#close} is
   * called, or possibly not at all if the {@link
   * org.apache.lucene.index.IndexWriter#rollback} is called.
   *
   * <p><u>Note:</u> the last CommitPoint is the most recent one,
   * i.e. the "front index state". Be careful not to delete it,
   * unless you know for sure what you are doing, and unless 
   * you can afford to lose the index content while doing that.
   *  
   * @param commits List of {@link org.apache.lucene.index.IndexCommit},
   *  sorted by age (the 0th one is the oldest commit).
   */
