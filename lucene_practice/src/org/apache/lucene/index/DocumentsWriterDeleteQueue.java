...
/**
 * {@link org.apache.lucene.index.DocumentsWriterDeleteQueue} is a non-blocking linked pending deletes
 ...
 * <p>
 * Since each {@link org.apache.lucene.index.DocumentsWriterDeleteQueue.DeleteSlice} maintains its own head and the list is only
 ...
 * indirectly referenced by one of the DWPT's private {@link org.apache.lucene.index.DocumentsWriterDeleteQueue.DeleteSlice} or by
 * the global {@link org.apache.lucene.index.BufferedDeletes} slice.
 * <p>
 ...
 * <li>updates its private {@link org.apache.lucene.index.DocumentsWriterDeleteQueue.DeleteSlice} either by calling
 * {@link #updateSlice(org.apache.lucene.index.DocumentsWriterDeleteQueue.DeleteSlice)} or {@link #add(org.apache.lucene.index.Term, org.apache.lucene.index.DocumentsWriterDeleteQueue.DeleteSlice)} (if the
 * document has a delTerm)</li>
 * <li>applies all deletes in the slice to its private {@link org.apache.lucene.index.BufferedDeletes}
 * and resets it</li>
