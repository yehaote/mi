 ...
 * 
 * @see org.apache.lucene.index.TwoPhaseCommit
 * @lucene.experimental
 */
public final class TwoPhaseCommitTool {
  ...
  /**
   * Thrown by {@link org.apache.lucene.index.TwoPhaseCommitTool#execute(org.apache.lucene.index.TwoPhaseCommit...)} when an
   ...
   * {@link org.apache.lucene.index.TwoPhaseCommit#prepareCommit()} all objects and only if all succeed,
   * it proceeds with {@link org.apache.lucene.index.TwoPhaseCommit#commit()}. If any of the objects
   * fail on either the preparation or actual commit, it terminates and
   * {@link org.apache.lucene.index.TwoPhaseCommit#rollback()} all of them.
   * <p>
   ...
   * skips over them.
   * 
   * @throws org.apache.lucene.index.TwoPhaseCommitTool.PrepareCommitFailException
   *           if any of the objects fail to
   *           {@link org.apache.lucene.index.TwoPhaseCommit#prepareCommit()}
   * @throws org.apache.lucene.index.TwoPhaseCommitTool.CommitFailException
   *           if any of the objects fail to {@link org.apache.lucene.index.TwoPhaseCommit#commit()}
   */
