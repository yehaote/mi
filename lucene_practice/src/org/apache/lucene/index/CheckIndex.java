...
public class CheckIndex {
  ...
  public static class Status {
     ...
     *  @see org.apache.lucene.index.CheckIndex#checkIndex(java.util.List) */
    public List<String> segmentsChecked = new ArrayList<String>();
  
    /** True if the index was created with a newer version of Lucene than the CheckIndex tool. */
    public boolean toolOutOfDate;

    /** List of {@link org.apache.lucene.index.CheckIndex.Status.SegmentInfoStatus} instances, detailing status of each segment. */
     ...
     * had no problems (this is used with the {@link org.apache.lucene.index.CheckIndex#fixIndex}
     ...
     * #checkIndex(java.util.List)}) was called with non-null
     * argument). */
  ...
  /** Set infoStream where messages should go. See {@link #setInfoStream(java.io.PrintStream,boolean)}. */
  ...
  /** Returns a {@link org.apache.lucene.index.CheckIndex.Status} instance detailing
