...
/**
 * Controls the health status of a {@link org.apache.lucene.index.DocumentsWriter} sessions. This class
 * used to block incoming indexing threads if flushing significantly slower than
 * indexing to ensure the {@link org.apache.lucene.index.DocumentsWriter}s healthiness. If flushing is
 * significantly slower than indexing the net memory used within an
 * {@link org.apache.lucene.index.IndexWriter} session can increase very quickly and easily exceed the
...
final class DocumentsWriterStallControl {
   ...
   * {@link org.apache.lucene.index.DocumentsWriterPerThread} is greater than the number of active
   * {@link org.apache.lucene.index.DocumentsWriterPerThread}. Otherwise it will reset the
   * {@link org.apache.lucene.index.DocumentsWriterStallControl} to healthy and release all threads
