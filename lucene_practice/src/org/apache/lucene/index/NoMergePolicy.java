...
/**
 * A {@link org.apache.lucene.index.MergePolicy} which never returns merges to execute (hence it's
 * name). It is also a singleton and can be accessed through
 * {@link org.apache.lucene.index.NoMergePolicy#NO_COMPOUND_FILES} if you want to indicate the index
 * does not use compound files, or through {@link org.apache.lucene.index.NoMergePolicy#COMPOUND_FILES}
 * otherwise. Use it if you want to prevent an {@link org.apache.lucene.index.IndexWriter} from ever
...
public final class NoMergePolicy extends MergePolicy {
  ...
  /**
   * A singleton {@link org.apache.lucene.index.NoMergePolicy} which indicates the index does not use
   * compound files.
   */
  public static final MergePolicy NO_COMPOUND_FILES = new NoMergePolicy(false);

  /**
   * A singleton {@link org.apache.lucene.index.NoMergePolicy} which indicates the index uses compound
   * files.
   */
