...
/**
 * A {@link org.apache.lucene.index.DocumentsWriterPerThreadPool} implementation that tries to assign an
 * indexing thread to the same {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState} each time the thread tries to
 * obtain a {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState}. Once a new {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState} is created it is
 * associated with the creating thread. Subsequently, if the threads associated
 * {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState} is not in use it will be associated with the requesting
 * thread. Otherwise, if the {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState} is used by another thread
 * {@link org.apache.lucene.index.ThreadAffinityDocumentsWriterThreadPool} tries to find the currently
 * minimal contended {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState}.
 */
class ThreadAffinityDocumentsWriterThreadPool extends DocumentsWriterPerThreadPool {
  ...
  /**
   * Creates a new {@link org.apache.lucene.index.ThreadAffinityDocumentsWriterThreadPool} with a given maximum of {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState}s.
   */
