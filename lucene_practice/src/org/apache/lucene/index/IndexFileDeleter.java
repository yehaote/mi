...
final class IndexFileDeleter implements Closeable {
   ...
   * {@link IndexDeletionPolicy#onCommit(java.util.List)} again with the known commits.
   ...
   * {@link org.apache.lucene.index.IndexWriter#deleteUnusedFiles()}, which will attempt to delete the
