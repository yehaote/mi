...
/**
 * {@link org.apache.lucene.index.FlushPolicy} controls when segments are flushed from a RAM resident
 ...
 * </ul>
 * 
 * The {@link IndexWriter} consults a provided {@link org.apache.lucene.index.FlushPolicy} to control the
 * flushing process. The policy is informed for each added or
 * updated document as well as for each delete term. Based on the
 * {@link org.apache.lucene.index.FlushPolicy}, the information provided via {@link ThreadState} and
 * {@link DocumentsWriterFlushControl}, the {@link org.apache.lucene.index.FlushPolicy} decides if a
 ...
 * @see IndexWriterConfig#setFlushPolicy(org.apache.lucene.index.FlushPolicy)
 */
