...
/**
 * Holds all the configuration that is used to create an {@link org.apache.lucene.index.IndexWriter}.
 * Once {@link org.apache.lucene.index.IndexWriter} has been created with this object, changes to this
 * object will not affect the {@link org.apache.lucene.index.IndexWriter} instance. For that, use
 * {@link LiveIndexWriterConfig} that is returned from {@link org.apache.lucene.index.IndexWriter#getConfig()}.
 * 
 * <p>
 * All setter methods return {@link org.apache.lucene.index.IndexWriterConfig} to allow chaining
 ...
 * </pre>
 * 
 * @see org.apache.lucene.index.IndexWriter#getConfig()
 * 
 * @since 3.1
 */
public final class IndexWriterConfig extends LiveIndexWriterConfig implements Cloneable {
  ...
  /**
   * Specifies the open mode for {@link org.apache.lucene.index.IndexWriter}.
   */
   ...
   * {@link org.apache.lucene.util.Version} as well as the default {@link
   * Analyzer}. If matchVersion is >= {@link
   * org.apache.lucene.util.Version#LUCENE_32}, {@link TieredMergePolicy} is used
  ...
  /** Specifies {@link org.apache.lucene.index.IndexWriterConfig.OpenMode} of the index.
   * 
  ...
  /**
   * Expert: {@link org.apache.lucene.index.MergePolicy} is invoked whenever there are changes to the
   * segments in the index. Its role is to select which merges to do, if any,
   * and return a {@link org.apache.lucene.index.MergePolicy.MergeSpecification} describing the merges.
   ...
   * {@link DocumentsWriterPerThreadPool} is set {@link org.apache.lucene.index.IndexWriter} will use
   ...
   * other {@link org.apache.lucene.index.IndexWriter} instances once it has been initialized / associated with an
   ...
   *  obtained by calling {@link org.apache.lucene.index.DirectoryReader#open(org.apache.lucene.index.IndexWriter, boolean)}.
   *  This method lets you enable pooling without getting a
   *  near-real-time reader.  NOTE: if you set this to
   *  false, IndexWriter will still pool readers once
   *  {@link org.apache.lucene.index.DirectoryReader#open(org.apache.lucene.index.IndexWriter, boolean)} is called.
   *
   * <p>Only takes effect when IndexWriter is first created. */
  ...
  /** Expert: sets the {@link org.apache.lucene.index.DocConsumer} chain to be used to process documents.
   *
   * <p>Only takes effect when IndexWriter is first created. */
   ...
   * The {@link org.apache.lucene.index.FlushPolicy} initialized during {@link org.apache.lucene.index.IndexWriter} instantiation and once initialized
   * the given instance is bound to this {@link org.apache.lucene.index.IndexWriter} and should not be used with another writer.
  ...
  /** Convenience method that uses {@link org.apache.lucene.util.PrintStreamInfoStream} */
