 ...
 * {@link org.apache.lucene.index.IndexWriter}, either the addition of a newly
 * flushed segment, addition of many segments from
 * addIndexes* calls, or a previous merge that may now need
 * to cascade, {@link org.apache.lucene.index.IndexWriter} invokes {@link
 * #findMerges} to give the MergePolicy a chance to pick
 * merges that are now required.  This method returns a
 * {@link org.apache.lucene.index.MergePolicy.MergeSpecification} instance describing the set of
 * merges that should be done, or null if no merges are
 * necessary.  When IndexWriter.forceMerge is called, it calls
 * {@link #findForcedMerges(SegmentInfos,int, java.util.Map)} and the MergePolicy should
...
public abstract class MergePolicy implements java.io.Closeable, Cloneable {
  ...
  public static class OneMerge {
     ...
     *  to feed SegmentMerger to initialize a merge. When a {@link org.apache.lucene.index.MergePolicy.OneMerge}
    ...
    /**
     * Expert: Sets the {@link SegmentInfoPerCommit} of this {@link org.apache.lucene.index.MergePolicy.OneMerge}.
    ...
    /** Called periodically by {@link org.apache.lucene.index.IndexWriter} while
   ...
   * contains a list of {@link org.apache.lucene.index.MergePolicy.OneMerge} instances.
   */
  ...
  public static class MergeSpecification {
     ...
     *  #add(org.apache.lucene.index.MergePolicy.OneMerge)} to add merges. */
    public MergeSpecification() {
    }

    /** Adds the provided {@link org.apache.lucene.index.MergePolicy.OneMerge} to this
     *  specification. */
   ...
   *  {@link org.apache.lucene.index.IndexWriter#close(boolean)} was called with
   *  <code>false</code>.  Normally this exception is
   *  privately caught and suppresed by {@link org.apache.lucene.index.IndexWriter}.  */
  public static class MergeAbortedException extends IOException {
    /** Create a {@link org.apache.lucene.index.MergePolicy.MergeAbortedException}. */
    public MergeAbortedException() {
      super("merge is aborted");
    }

    /** Create a {@link org.apache.lucene.index.MergePolicy.MergeAbortedException} with a
     *  specified message. */
  ...
  /** {@link org.apache.lucene.index.IndexWriter} that contains this instance. */
   ...
   * without passing it to {@link org.apache.lucene.index.IndexWriter}, you should call
   * {@link #setIndexWriter(org.apache.lucene.index.IndexWriter)}.
   */
  public MergePolicy() {
  ...
  /**
   * Sets the {@link org.apache.lucene.index.IndexWriter} to use by this merge policy. This method is
   * allowed to be called only once, and is usually set by IndexWriter. If it is
   * called more than once, {@link org.apache.lucene.util.SetOnce.AlreadySetException} is thrown.
   * 
   * @see org.apache.lucene.util.SetOnce
   */
   ...
   * {@link org.apache.lucene.index.IndexWriter} calls this whenever there is a change to the segments.
   * This call is always synchronized on the {@link org.apache.lucene.index.IndexWriter} instance so
   ...
   * order to merge to <= the specified segment count. {@link org.apache.lucene.index.IndexWriter} calls this when its
   * {@link org.apache.lucene.index.IndexWriter#forceMerge} method is called. This call is always
   * synchronized on the {@link org.apache.lucene.index.IndexWriter} instance so only one thread at a
   ...
   * {@link org.apache.lucene.index.MergePolicy#findMerges(org.apache.lucene.index.MergePolicy.MergeTrigger, SegmentInfos)} to indicate the
