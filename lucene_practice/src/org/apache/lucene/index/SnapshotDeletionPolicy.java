...
/**
 * An {@link org.apache.lucene.index.IndexDeletionPolicy} that wraps around any other
 * {@link org.apache.lucene.index.IndexDeletionPolicy} and adds the ability to hold and later release
 * snapshots of an index. While a snapshot is held, the {@link org.apache.lucene.index.IndexWriter} will
 ...
 * {@link org.apache.lucene.index.IndexDeletionPolicy}, this gives you the freedom to continue using
 * whatever {@link org.apache.lucene.index.IndexDeletionPolicy} you would normally want to use with your
 * index.
 * 
 * <p>
 ...
 * {@link #SnapshotDeletionPolicy(org.apache.lucene.index.IndexDeletionPolicy, java.util.Map)}.
 * 
 * @lucene.experimental
 */
public class SnapshotDeletionPolicy extends IndexDeletionPolicy {
  ...
  /** Wraps a provided {@link org.apache.lucene.index.IndexCommit} and prevents it
   *  from being deleted. */
  protected class SnapshotCommitPoint extends IndexCommit {

    /** The {@link org.apache.lucene.index.IndexCommit} we are preventing from deletion. */
  ...
  /** Most recently committed {@link org.apache.lucene.index.IndexCommit}. */
  protected IndexCommit lastCommit;

  /** Sole constructor, taking the incoming {@link
   *  org.apache.lucene.index.IndexDeletionPolicy} to wrap. */
  public SnapshotDeletionPolicy(IndexDeletionPolicy primary) {
    this.primary = primary;
  }

  /**
   * {@link org.apache.lucene.index.SnapshotDeletionPolicy} wraps another {@link org.apache.lucene.index.IndexDeletionPolicy} to
   * enable flexible snapshotting.
   * 
   * @param primary
   *          the {@link org.apache.lucene.index.IndexDeletionPolicy} that is used on non-snapshotted
  ...
  /** Wraps each {@link org.apache.lucene.index.IndexCommit} as a {@link
   ...
   * @return The {@link org.apache.lucene.index.IndexCommit} for this particular snapshot.
   */
   ...
   * {@link #SnapshotDeletionPolicy(org.apache.lucene.index.IndexDeletionPolicy, java.util.Map)} in order to
   ...
   * from deletion (as long as this {@link org.apache.lucene.index.IndexDeletionPolicy} is used). The
   * commit can be removed by calling {@link #release(String)} using the same ID
   * parameter followed by a call to {@link org.apache.lucene.index.IndexWriter#deleteUnusedFiles()}.
   * <p>
   ...
   * @return the {@link org.apache.lucene.index.IndexCommit} that was snapshotted.
   */
