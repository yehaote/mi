...
/** This {@link org.apache.lucene.index.MergePolicy} is used for upgrading all existing segments of
  * an index when calling {@link org.apache.lucene.index.IndexWriter#forceMerge(int)}.
  ...
  * <p>In general one would use {@link org.apache.lucene.index.IndexUpgrader}, but for a fully customizeable upgrade,
  * you can use this like any other {@code MergePolicy} and call {@link org.apache.lucene.index.IndexWriter#forceMerge(int)}:
...
public class UpgradeIndexMergePolicy extends MergePolicy {
  ...
  /** Wrapped {@link org.apache.lucene.index.MergePolicy}. */
  protected final MergePolicy base;

  /** Wrap the given {@link org.apache.lucene.index.MergePolicy} and intercept forceMerge requests to
