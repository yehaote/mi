...
/** Iterator to seek ({@link #seekCeil(org.apache.lucene.util.BytesRef)}, {@link
 * #seekExact(org.apache.lucene.util.BytesRef,boolean)}) or step through ({@link
 * #next} terms to obtain frequency information ({@link
 * #docFreq}), {@link org.apache.lucene.index.DocsEnum} or {@link
...
public abstract class TermsEnum implements BytesRefIterator {
  ...
  /** Expert: just like {@link #seekCeil(org.apache.lucene.util.BytesRef)} but allows
   ...
   * this {@link org.apache.lucene.index.TermsEnum} in undefined state. On a segment level
   * {@link TermState} instances are compatible only iff the source and the
   * target {@link org.apache.lucene.index.TermsEnum} operate on the same field. If operating on segment
   * level, TermState instances must not be used across segments.
   * <p>
   * NOTE: A seek by {@link TermState} might not restore the
   * {@link org.apache.lucene.util.AttributeSource}'s state. {@link org.apache.lucene.util.AttributeSource} states must be
   ...
   *  {@link org.apache.lucene.index.TermsEnum.SeekStatus#END}.*/
  ...
  /** Get {@link org.apache.lucene.index.DocsEnum} for the current term.  Do not
  ...
  /** Get {@link org.apache.lucene.index.DocsEnum} for the current term, with
   ...
   *        you require; see {@link org.apache.lucene.index.DocsEnum#FLAG_FREQS}
   * @see #docs(org.apache.lucene.util.Bits, org.apache.lucene.index.DocsEnum, int) */
   ...
   *  @see #docsAndPositions(org.apache.lucene.util.Bits, DocsAndPositionsEnum, int) */
   ...
   * {@link org.apache.lucene.util.AttributeSource}'s state. Callers must maintain the
   * {@link org.apache.lucene.util.AttributeSource} states separately
   * 
   * @see TermState
   * @see #seekExact(org.apache.lucene.util.BytesRef, TermState)
   */
