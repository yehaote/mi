...
/**
 * {@link org.apache.lucene.index.DocumentsWriterPerThreadPool} controls {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState} instances
 * and their thread assignments during indexing. Each {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState} holds
 * a reference to a {@link org.apache.lucene.index.DocumentsWriterPerThread} that is once a
 * {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState} is obtained from the pool exclusively used for indexing a
 * single document by the obtaining thread. Each indexing thread must obtain
 * such a {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState} to make progress. Depending on the
 * {@link org.apache.lucene.index.DocumentsWriterPerThreadPool} implementation {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState}
 * assignments might differ from document to document.
 * <p>
 * Once a {@link org.apache.lucene.index.DocumentsWriterPerThread} is selected for flush the thread pool
...
abstract class DocumentsWriterPerThreadPool implements Cloneable {
  ...
  /**
   * {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState} references and guards a
   * {@link org.apache.lucene.index.DocumentsWriterPerThread} instance that is used during indexing to
   * build a in-memory index segment. {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState} also holds all flush
   * related per-thread data controlled by {@link org.apache.lucene.index.DocumentsWriterFlushControl}.
   * <p>
   * A {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState}, its methods and members should only accessed by one
   * thread a time. Users must acquire the lock via {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState#lock()}
   * and release the lock in a finally block via {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState#unlock()}
  ...
  final static class ThreadState extends ReentrantLock {
    ...
    /**
     * Resets the internal {@link org.apache.lucene.index.DocumentsWriterPerThread} with the given one.
    ...
    /**
     * Returns this {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState}s {@link org.apache.lucene.index.DocumentsWriterPerThread}
     */
    ...
    /**
     * Returns <code>true</code> iff this {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState} is marked as flush
  ...
  /**
   * Returns the max number of {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState} instances available in this
  ...
  /**
   * Returns the active number of {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState} instances.
   */
  ...
  /**
   * Returns a new {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState} iff any new state is available otherwise
   * <code>null</code>.
   * <p>
   * NOTE: the returned {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState} is already locked iff non-
   * <code>null</code>.
   * 
   * @return a new {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState} iff any new state is available otherwise
   *         <code>null</code>
   */
  ...
  /**
   * Returns the <i>i</i>th active {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState} where <i>i</i> is the
   * given ord.
   * 
   * @param ord
   *          the ordinal of the {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState}
   * @return the <i>i</i>th active {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState} where <i>i</i> is the
   *         given ord.
   */
   ...
   * waiting to acquire its lock or <code>null</code> if no {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState}
  ...
  /**
   * Returns the number of currently deactivated {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState} instances.
   * A deactivated {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState} should not be used for indexing anymore.
   * 
   * @return the number of currently deactivated {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState} instances.
   */
  ...
  /**
   * Deactivates an active {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState}. Inactive {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState} can
   * not be used for indexing anymore once they are deactivated. This method should only be used
   * if the parent {@link org.apache.lucene.index.DocumentsWriter} is closed or aborted.
   * 
  ...
  /**
   * Reinitialized an active {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState}. A {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState} should
