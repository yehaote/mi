 ...
 * ({@link DefaultSimilarity}), you must override {@link DefaultSimilarity#scorePayload(int, int, int, org.apache.lucene.util.BytesRef)},
 * which returns 1 by default.
 * <p/>
 * Payload scores are aggregated using a pluggable {@link org.apache.lucene.search.payloads.PayloadFunction}.
 * 
 * @see org.apache.lucene.search.similarities.Similarity.SloppySimScorer#computePayloadFactor(int, int, int, org.apache.lucene.util.BytesRef)
 */
public class PayloadNearQuery extends SpanNearQuery {
  ...
  public class PayloadNearSpanScorer extends SpanScorer {
    ...
    /**
     * By default, uses the {@link org.apache.lucene.search.payloads.PayloadFunction} to score the payloads, but
