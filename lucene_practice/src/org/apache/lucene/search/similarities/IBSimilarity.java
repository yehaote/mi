 ...
 * <ol>
 *     <li>{@link org.apache.lucene.search.similarities.Distribution}: Probabilistic distribution used to
 ...
 *         </ul>
 *     </li>
 *     <li>{@link org.apache.lucene.search.similarities.Lambda}: &lambda;<sub>w</sub> parameter of the
 *         probability distribution
 *         <ul>
 *             <li>{@link org.apache.lucene.search.similarities.LambdaDF}: <code>N<sub>w</sub>/N</code> or average
 *                 number of documents where w occurs</li>
 *             <li>{@link org.apache.lucene.search.similarities.LambdaTTF}: <code>F<sub>w</sub>/N</code> or
...
public class IBSimilarity extends SimilarityBase {
   ...
   * parameters, refer to the javadoc of the {@link org.apache.lucene.search.similarities.Lambda} classes.
   */
  @Override
