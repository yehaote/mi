 ...
 * <ul>
 *   <li>{@link org.apache.lucene.search.similarities.LMSimilarity.LMStats}, which defines a new statistic, the probability that
 *   the collection language model generates the current term;</li>
 *   <li>{@link org.apache.lucene.search.similarities.LMSimilarity.CollectionModel}, which is a strategy interface for object that
 *   compute the collection language model {@code p(w|C)};</li>
 *   <li>{@link org.apache.lucene.search.similarities.LMSimilarity.DefaultCollectionModel}, an implementation of the former, that
...
public abstract class LMSimilarity extends SimilarityBase {
   ...
   * @see #getName()
   * @see org.apache.lucene.search.similarities.LMSimilarity.CollectionModel#getName()
   * @see org.apache.lucene.search.similarities.LMSimilarity.DefaultCollectionModel
   */
  @Override
