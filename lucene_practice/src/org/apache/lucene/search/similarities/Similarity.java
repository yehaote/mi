 ...
 * <p>
 * <a name="indextime"/>
 * At indexing time, the indexer calls {@link #computeNorm(org.apache.lucene.index.FieldInvertState)}, allowing
 * the Similarity implementation to set a per-document value for the field that will 
 * be later accessible via {@link org.apache.lucene.index.AtomicReader#getNormValues(String)}.  Lucene makes no assumption
 ...
 * and length normalization information with {@link org.apache.lucene.util.SmallFloat} into a single byte, this
 ...
 * at query-time with {@link org.apache.lucene.index.AtomicReader#getNumericDocValues(String)}.
 * <p>
 ...
 *       stored in the returned {@link org.apache.lucene.search.similarities.Similarity.SimWeight} object.
 *   <li>The query normalization process occurs a single time: {@link org.apache.lucene.search.similarities.Similarity.SimWeight#getValueForNormalization()}
 *       is called for each query leaf node, {@link org.apache.lucene.search.similarities.Similarity#queryNorm(float)} is called for the top-level
 *       query, and finally {@link org.apache.lucene.search.similarities.Similarity.SimWeight#normalize(float, float)} passes down the normalization value
 *       and any top-level boosts (e.g. from enclosing {@link BooleanQuery}s).
 *   <li>For each segment in the index, the Query creates a {@link #exactSimScorer(org.apache.lucene.search.similarities.Similarity.SimWeight, org.apache.lucene.index.AtomicReaderContext)}
 *       (for queries with exact frequencies such as TermQuerys and exact PhraseQueries) or a 
 *       {@link #sloppySimScorer(org.apache.lucene.search.similarities.Similarity.SimWeight, org.apache.lucene.index.AtomicReaderContext)} (for queries with sloppy frequencies such as
 ...
 * was computed.
 *
 * @see org.apache.lucene.index.IndexWriterConfig#setSimilarity(org.apache.lucene.search.similarities.Similarity)
 * @see IndexSearcher#setSimilarity(org.apache.lucene.search.similarities.Similarity)
 * @lucene.experimental
 */
public abstract class Similarity {
   ...
   * normalized weights {@link org.apache.lucene.search.similarities.Similarity.SimWeight#getValueForNormalization()} of
   * each of the query terms.  This value is passed back to the 
   * weight ({@link org.apache.lucene.search.similarities.Similarity.SimWeight#normalize(float, float)} of each query
   ...
   * state of term processing for this field (see {@link org.apache.lucene.index.FieldInvertState}).
   *
  ...
  /**
   * Creates a new {@link org.apache.lucene.search.similarities.Similarity.ExactSimScorer} to score matching documents from a segment of the inverted index.
  ...
  /**
   * Creates a new {@link org.apache.lucene.search.similarities.Similarity.SloppySimScorer} to score matching documents from a segment of the inverted index.
   * @param weight collection information from {@link #computeWeight(float, CollectionStatistics, TermStatistics...)}
   * @param context segment of the inverted index to be scored.
  ...
  /**
   * API for scoring "sloppy" queries such as {@link org.apache.lucene.search.spans.SpanQuery} and
   * sloppy {@link PhraseQuery}.
   * <p>
   * Frequencies are floating-point values: an approximate 
   * within-document frequency adjusted for "sloppiness" by 
   * {@link org.apache.lucene.search.similarities.Similarity.SloppySimScorer#computeSlopFactor(int)}.
   */
