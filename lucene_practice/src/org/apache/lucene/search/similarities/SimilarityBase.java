 ...
 * {@link #explain(Explanation, org.apache.lucene.search.similarities.BasicStats, int, float, float)} is optional,
...
public abstract class SimilarityBase extends Similarity {
   ...
   * attaches the score (computed via the {@link #score(org.apache.lucene.search.similarities.BasicStats, float, float)}
   * method) and the explanation for the term frequency. Subclasses content with
   * this format may add additional details in
   * {@link #explain(Explanation, org.apache.lucene.search.similarities.BasicStats, int, float, float)}.
   *  
   * @param stats the corpus level statistics.
   * @param doc the document id.
   ...
   * {@link org.apache.lucene.search.similarities.SimilarityBase#score(org.apache.lucene.search.similarities.BasicStats, float, float)} and
   * {@link org.apache.lucene.search.similarities.SimilarityBase#explain(org.apache.lucene.search.similarities.BasicStats, int, Explanation, float)},
   * respectively.
   */
