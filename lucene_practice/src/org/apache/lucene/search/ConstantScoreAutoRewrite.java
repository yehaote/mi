...
class ConstantScoreAutoRewrite extends TermCollectingRewrite<BooleanQuery> {
   ...
   *  org.apache.lucene.search.MultiTermQuery#CONSTANT_SCORE_FILTER_REWRITE} is used. */
  ...
  /** Special implementation of BytesStartArray that keeps parallel arrays for {@link org.apache.lucene.index.TermContext} */
