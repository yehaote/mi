...
public class FuzzyQuery extends MultiTermQuery {
  ...
  /**
   * Calls {@link #FuzzyQuery(org.apache.lucene.index.Term, int, int, int, boolean)
  ...
  /**
   * Calls {@link #FuzzyQuery(org.apache.lucene.index.Term, int, int) FuzzyQuery(term, maxEdits, defaultPrefixLength)}.
   */
  ...
  /**
   * Calls {@link #FuzzyQuery(org.apache.lucene.index.Term, int) FuzzyQuery(term, defaultMaxEdits)}.
   */
