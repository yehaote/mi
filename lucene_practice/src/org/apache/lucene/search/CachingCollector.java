 ...
 * this returns true, you can use {@link #replay(org.apache.lucene.search.Collector)}
...
public abstract class CachingCollector extends Collector {
  ...
  /**
   * Creates a {@link org.apache.lucene.search.CachingCollector} which does not wrap another collector.
   * The cached documents and scores can later be {@link #replay(org.apache.lucene.search.Collector)
   * replayed}.
   * 
  ...
  /**
   * Create a new {@link org.apache.lucene.search.CachingCollector} that wraps the given collector and
