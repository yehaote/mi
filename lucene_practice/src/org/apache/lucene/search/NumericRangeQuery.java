...
/**
 * <p>A {@link org.apache.lucene.search.Query} that matches numeric values within a
 ...
 * you should use {@link org.apache.lucene.search.TermRangeQuery}.  {@link
 ...
 * than the corresponding {@link org.apache.lucene.search.TermRangeQuery} because the
 ...
 * org.apache.lucene.search.MultiTermQuery#CONSTANT_SCORE_AUTO_REWRITE_DEFAULT}.
 ...
 * see {@link org.apache.lucene.util.NumericUtils}). A range is then divided recursively into multiple intervals for searching:
 ...
 *  per value in the index and querying is as slow as a conventional {@link org.apache.lucene.search.TermRangeQuery}. But it can be used
 ...
 * that {@link org.apache.lucene.search.TermRangeQuery} in boolean rewrite mode (with raised {@link org.apache.lucene.search.BooleanQuery} clause count)
 * took about 30-40 secs to complete, {@link org.apache.lucene.search.TermRangeQuery} in constant score filter rewrite mode took 5 secs
...
public final class NumericRangeQuery<T extends Number> extends MultiTermQuery {
   ...
   * {@link org.apache.lucene.index.Term#compareTo}.
   * The ordering depends on how {@link org.apache.lucene.util.NumericUtils#splitLongRange} and
   * {@link org.apache.lucene.util.NumericUtils#splitIntRange} generates the sub-ranges. For
   * {@link org.apache.lucene.search.MultiTermQuery} ordering is not relevant.
   */
