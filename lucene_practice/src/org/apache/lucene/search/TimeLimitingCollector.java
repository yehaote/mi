...
/**
 * The {@link org.apache.lucene.search.TimeLimitingCollector} is used to timeout search requests that
 * take longer than the maximum allowed search time limit. After this time is
 * exceeded, the search thread is stopped by throwing a
 * {@link org.apache.lucene.search.TimeLimitingCollector.TimeExceededException}.
 */
public class TimeLimitingCollector extends Collector {
  ...
  /**
   * Create a TimeLimitedCollector wrapper over another {@link org.apache.lucene.search.Collector} with a specified timeout.
   * @param collector the wrapped {@link org.apache.lucene.search.Collector}
   * @param clock the timer clock
   * @param ticksAllowed max time allowed for collecting
   * hits after which {@link org.apache.lucene.search.TimeLimitingCollector.TimeExceededException} is thrown
   */
  ...
  /**
   * Syntactic sugar for {@link #setBaseline(long)} using {@link org.apache.lucene.util.Counter#get()}
   ...
   * A non greedy collector, upon a timeout, would throw a {@link org.apache.lucene.search.TimeLimitingCollector.TimeExceededException}
   * without allowing the wrapped collector to collect current doc. A greedy one would 
   * first allow the wrapped hit collector to collect current doc and only then 
   * throw a {@link org.apache.lucene.search.TimeLimitingCollector.TimeExceededException}.
  ...
  /**
   * Returns the global TimerThreads {@link org.apache.lucene.util.Counter}
   * <p>
   * Invoking this creates may create a new instance of {@link org.apache.lucene.search.TimeLimitingCollector.TimerThread} iff
   * the global {@link org.apache.lucene.search.TimeLimitingCollector.TimerThread} has never been accessed before. The thread
   * returned from this method is started on creation and will be alive unless
   * you stop the {@link org.apache.lucene.search.TimeLimitingCollector.TimerThread} via {@link org.apache.lucene.search.TimeLimitingCollector.TimerThread#stopTimer()}.
   * </p>
   * @return the global TimerThreads {@link org.apache.lucene.util.Counter}
   * @lucene.experimental
   */
  ...
  /**
   * Returns the global {@link org.apache.lucene.search.TimeLimitingCollector.TimerThread}.
   * <p>
   * Invoking this creates may create a new instance of {@link org.apache.lucene.search.TimeLimitingCollector.TimerThread} iff
   * the global {@link org.apache.lucene.search.TimeLimitingCollector.TimerThread} has never been accessed before. The thread
   * returned from this method is started on creation and will be alive unless
   ...
   * </p>
   * 
   * @return the global {@link org.apache.lucene.search.TimeLimitingCollector.TimerThread}
   * @lucene.experimental
   */
   ...
   * Can be stopped completely with {@link org.apache.lucene.search.TimeLimitingCollector.TimerThread#stopTimer()}
   * @lucene.experimental
   */
