...
class BooleanScorer2 extends Scorer {
  ...
  /**
   * Creates a {@link org.apache.lucene.search.Scorer} with the given similarity and lists of required,
   ...
   *          ({@link org.apache.lucene.search.similarities.Similarity#coord(int, int)}) is not used.
