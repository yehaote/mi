...
/**
 * An abstract {@link org.apache.lucene.search.Query} that matches documents
 * containing a subset of terms provided by a {@link
 * org.apache.lucene.index.FilteredTermsEnum} enumeration.
 *
 * <p>This query cannot be used directly; you must subclass
 * it and define {@link #getTermsEnum(org.apache.lucene.index.Terms, org.apache.lucene.util.AttributeSource)} to provide a {@link
 * org.apache.lucene.index.FilteredTermsEnum} that iterates through the terms to be
 * matched.
 *
 ...
 * {@link org.apache.lucene.search.BooleanQuery.TooManyClauses} exception during
 * searching, which happens when the number of terms to be
 * searched exceeds {@link
 * org.apache.lucene.search.BooleanQuery#getMaxClauseCount()}.  Setting {@link
 ...
 * need scoring (like {@link org.apache.lucene.search.FuzzyQuery}, use
 * {@link org.apache.lucene.search.MultiTermQuery.TopTermsScoringBooleanQueryRewrite} which uses
...
public abstract class MultiTermQuery extends Query {
  ...
  public static abstract class RewriteMethod {
    ...
    /**
     * Returns the {@link org.apache.lucene.search.MultiTermQuery}s {@link org.apache.lucene.index.TermsEnum}
     * @see org.apache.lucene.search.MultiTermQuery#getTermsEnum(org.apache.lucene.index.Terms, org.apache.lucene.util.AttributeSource)
     */
   ...
   *  hit an errant {@link org.apache.lucene.search.BooleanQuery.TooManyClauses}
   *  exception.
   *
   ...
   *  {@link org.apache.lucene.search.BooleanClause.Occur#SHOULD} clause in a
   ...
   *  org.apache.lucene.search.BooleanQuery.TooManyClauses} if the number of terms
   *  exceeds {@link org.apache.lucene.search.BooleanQuery#getMaxClauseCount}.
   *
   *  @see #setRewriteMethod */
  ...
  /**
   * A rewrite method that first translates each term into
   * {@link org.apache.lucene.search.BooleanClause.Occur#SHOULD} clause in a BooleanQuery, and keeps the
   * scores as computed by the query.
   * 
   * <p>
   * This rewrite method only uses the top scoring terms so it will not overflow
   * the boolean max clause count. It is the default rewrite method for
   * {@link org.apache.lucene.search.FuzzyQuery}.
   * 
   * @see #setRewriteMethod
   */
  public static final class TopTermsScoringBooleanQueryRewrite extends TopTermsRewrite<BooleanQuery> {
     ...
     * <p>
     * NOTE: if {@link org.apache.lucene.search.BooleanQuery#getMaxClauseCount} is smaller than
  ...
  /**
   * A rewrite method that first translates each term into
   * {@link org.apache.lucene.search.BooleanClause.Occur#SHOULD} clause in a BooleanQuery, but the scores
   ...
   *  org.apache.lucene.search.MultiTermQuery.ConstantScoreAutoRewrite}, with {@link
   *  org.apache.lucene.search.MultiTermQuery.ConstantScoreAutoRewrite#setTermCountCutoff} set to
   *  {@link
   *  org.apache.lucene.search.MultiTermQuery.ConstantScoreAutoRewrite#DEFAULT_TERM_COUNT_CUTOFF}
   *  and {@link
   *  org.apache.lucene.search.MultiTermQuery.ConstantScoreAutoRewrite#setDocCountPercent} set to
   *  {@link
   *  org.apache.lucene.search.MultiTermQuery.ConstantScoreAutoRewrite#DEFAULT_DOC_COUNT_PERCENT}.
   ...
   *  (should instead return {@link org.apache.lucene.index.TermsEnum#EMPTY} if no
   *  terms match).  The TermsEnum must already be
   *  positioned to the first matching term.
   * The given {@link org.apache.lucene.util.AttributeSource} is passed by the {@link org.apache.lucene.search.MultiTermQuery.RewriteMethod} to
   ...
   * enum from {@link #getTermsEnum(org.apache.lucene.index.Terms, org.apache.lucene.util.AttributeSource)}.  For example,
   * to rewrite to a single term, return a {@link org.apache.lucene.index.SingleTermsEnum}
   */
  @Override
   ...
   * implement your own subclass of {@link org.apache.lucene.search.MultiTermQuery.RewriteMethod}. */
