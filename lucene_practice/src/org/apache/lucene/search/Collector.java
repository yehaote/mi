 ...
 *   explicit {@link org.apache.lucene.search.Sort}. It is likely the most frequently
 *   used collector.</li>
 *
 *   <li>{@link TopFieldCollector} subclasses {@link
 *   TopDocsCollector} and sorts according to a specified
 *   {@link org.apache.lucene.search.Sort} object (sort by field).  This is used
 *   internally by the {@link IndexSearcher} search methods
 *   that take an explicit {@link org.apache.lucene.search.Sort}.
 *
 ...
 * passed {@link org.apache.lucene.search.Scorer} instance, and call {@link
 * org.apache.lucene.search.Scorer#score()} within the collect method to compute the
...
public abstract class Collector {
   ...
   * current {@link org.apache.lucene.index.AtomicReaderContext} will be skipped and {@link IndexSearcher}
  ...
  /**
   * Called before collecting from each {@link org.apache.lucene.index.AtomicReaderContext}. All doc ids in
   * {@link #collect(int)} will correspond to {@link org.apache.lucene.index.IndexReaderContext#reader}.
   * 
   * Add {@link org.apache.lucene.index.AtomicReaderContext#docBase} to the current  {@link org.apache.lucene.index.IndexReaderContext#reader}'s
