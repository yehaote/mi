...
/**
 * A {@link org.apache.lucene.search.Filter} that accepts all documents that have one or more values in a
 * given field. This {@link org.apache.lucene.search.Filter} request {@link org.apache.lucene.util.Bits} from the
 * {@link org.apache.lucene.search.FieldCache} and build the bits if not present.
 */
public class FieldValueFilter extends Filter {
  ...
  /**
   * Creates a new {@link org.apache.lucene.search.FieldValueFilter}
   * 
   * @param field
   *          the field to filter
   */
