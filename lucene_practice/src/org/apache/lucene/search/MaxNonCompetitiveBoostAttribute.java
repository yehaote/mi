...
/** Add this {@link org.apache.lucene.util.Attribute} to a fresh {@link org.apache.lucene.util.AttributeSource} before calling
 * {@link org.apache.lucene.search.MultiTermQuery#getTermsEnum(org.apache.lucene.index.Terms, org.apache.lucene.util.AttributeSource)}.
 * {@link org.apache.lucene.search.FuzzyQuery} is using this to control its internal behaviour
 * to only return competitive terms.
 * <p><b>Please note:</b> This attribute is intended to be added by the {@link org.apache.lucene.search.MultiTermQuery.RewriteMethod}
 * to an empty {@link org.apache.lucene.util.AttributeSource} that is shared for all segments
 * during query rewrite. This attribute source is passed to all segment enums
 * on {@link org.apache.lucene.search.MultiTermQuery#getTermsEnum(org.apache.lucene.index.Terms, org.apache.lucene.util.AttributeSource)}.
 * {@link org.apache.lucene.search.TopTermsRewrite} uses this attribute to
