...
/**
 * This is a {@link org.apache.lucene.search.PhraseQuery} which is optimized for n-gram phrase query.
 * For example, when you query "ABCD" on a 2-gram field, you may want to use
 * NGramPhraseQuery rather than {@link org.apache.lucene.search.PhraseQuery}, because NGramPhraseQuery
 * will {@link #rewrite(org.apache.lucene.index.IndexReader)} the query to "AB/0 CD/2", while {@link org.apache.lucene.search.PhraseQuery}
