 ...
 * {@link #search(org.apache.lucene.search.Query,int)}
 * or {@link #search(org.apache.lucene.search.Query, org.apache.lucene.search.Filter,int)} methods. For
 * performance reasons, if your index is unchanging, you
 * should share a single IndexSearcher instance across
 * multiple searches instead of creating a new one
 * per-search.  If your index has changed and you wish to
 * see the changes reflected in searching, you should
 * use {@link org.apache.lucene.index.DirectoryReader#openIfChanged(org.apache.lucene.index.DirectoryReader)}
 * to obtain a new reader and
 * then create a new IndexSearcher from that.  Also, for
 * low-latency turnaround it's best to use a near-real-time
 * reader ({@link org.apache.lucene.index.DirectoryReader#open(org.apache.lucene.index.IndexWriter,boolean)}).
 * Once you have a new {@link org.apache.lucene.index.IndexReader}, it's relatively
 * cheap to create a new IndexSearcher from it.
 * 
 * <a name="thread-safety"></a><p><b>NOTE</b>: <code>{@link
 * org.apache.lucene.search.IndexSearcher}</code> instances are completely
...
public class IndexSearcher {
   ...
   * {@link org.apache.lucene.search.IndexSearcher#getSimilarity()}.
   * @lucene.internal
   */
   ...
   *  if you are using {@link org.apache.lucene.store.NIOFSDirectory}, do not use
  ...
  /**
   * Creates a searcher searching the provided top-level {@link org.apache.lucene.index.IndexReaderContext}.
   * <p>
   * Given a non-<code>null</code> {@link java.util.concurrent.ExecutorService} this method runs
   ...
   * {@link org.apache.lucene.store.NIOFSDirectory}, do not use the shutdownNow method of
   * ExecutorService as this uses Thread.interrupt under-the-hood which can
   * silently close file descriptors (see <a
   * href="https://issues.apache.org/jira/browse/LUCENE-2239">LUCENE-2239</a>).
   * 
   * @see org.apache.lucene.index.IndexReaderContext
   * @see org.apache.lucene.index.IndexReader#getContext()
   * @lucene.experimental
   */
   ...
   * Each {@link org.apache.lucene.search.IndexSearcher.LeafSlice} is executed in a single thread. By default there
   * will be one {@link org.apache.lucene.search.IndexSearcher.LeafSlice} per leaf ({@link org.apache.lucene.index.AtomicReaderContext}).
   */
  ...
  /** Return the {@link org.apache.lucene.index.IndexReader} this searches. */
   ...
   * @see org.apache.lucene.index.IndexReader#document(int, java.util.Set)
   */
  ...
  /**
   * @deprecated Use {@link #doc(int, java.util.Set)} instead.
   */
  @Deprecated
   ...
   * large result sets.
   *
   * @throws org.apache.lucene.search.BooleanQuery.TooManyClauses If a query would exceed
   *         {@link org.apache.lucene.search.BooleanQuery#getMaxClauseCount()} clauses.
   */
   ...
   *
   * <p>{@link org.apache.lucene.search.Collector#collect(int)} is called for every matching
   * document.
   *
  ...
  /** Lower-level search API.
   *
   * <p>{@link org.apache.lucene.search.Collector#collect(int)} is called for every matching document.
   *
   * @throws org.apache.lucene.search.BooleanQuery.TooManyClauses If a query would exceed
   *         {@link org.apache.lucene.search.BooleanQuery#getMaxClauseCount()} clauses.
   */
   ...
   * {@link org.apache.lucene.search.IndexSearcher#search(org.apache.lucene.search.Query, org.apache.lucene.search.Filter,int, org.apache.lucene.search.Sort,boolean,boolean)} to
   * control scoring.
   *
   * @throws org.apache.lucene.search.BooleanQuery.TooManyClauses If a query would exceed
   *         {@link org.apache.lucene.search.BooleanQuery#getMaxClauseCount()} clauses.
   ...
   * hits for <code>query</code>, applying <code>filter</code> if non-null.
   *
   * <p>Applications should usually call {@link org.apache.lucene.search.IndexSearcher#search(org.apache.lucene.search.Query,int)} or
   * {@link org.apache.lucene.search.IndexSearcher#search(org.apache.lucene.search.Query, org.apache.lucene.search.Filter,int)} instead.
   * @throws org.apache.lucene.search.BooleanQuery.TooManyClauses If a query would exceed
   *         {@link org.apache.lucene.search.BooleanQuery#getMaxClauseCount()} clauses.
   */
   ...
   * org.apache.lucene.search.IndexSearcher#search(org.apache.lucene.search.Query, org.apache.lucene.search.Filter,int, org.apache.lucene.search.Sort)} instead.
   * 
   * @throws org.apache.lucene.search.BooleanQuery.TooManyClauses If a query would exceed
   *         {@link org.apache.lucene.search.BooleanQuery#getMaxClauseCount()} clauses.
   */
  ...
  /**
   * Just like {@link #search(org.apache.lucene.search.Weight, int, org.apache.lucene.search.Sort, boolean, boolean)}, but you choose
   * whether or not the fields in the returned {@link org.apache.lucene.search.FieldDoc} instances should
   * be set by specifying fillFields.
   *
   * <p>NOTE: this does not compute scores by default.  If you
   * need scores, create a {@link TopFieldCollector}
   * instance by calling {@link TopFieldCollector#create} and
   * then pass that to {@link #search(java.util.List, org.apache.lucene.search.Weight,
   * org.apache.lucene.search.Collector)}.</p>
   */
   ...
   * 
   * <p>
   * {@link org.apache.lucene.search.Collector#collect(int)} is called for every document. <br>
   * 
   * <p>
   ...
   * Computing an explanation is as expensive as executing the query over the
   * entire index.
   * <p>Applications should call {@link org.apache.lucene.search.IndexSearcher#explain(org.apache.lucene.search.Query, int)}.
   * @throws org.apache.lucene.search.BooleanQuery.TooManyClauses If a query would exceed
   *         {@link org.apache.lucene.search.BooleanQuery#getMaxClauseCount()} clauses.
   */
  ...
  /**
   * Creates a normalized weight for a top-level {@link org.apache.lucene.search.Query}.
   * The query is rewritten by this method and {@link org.apache.lucene.search.Query#createWeight} called,
   * afterwards the {@link org.apache.lucene.search.Weight} is normalized. The returned {@code Weight}
   * can then directly be used to get a {@link org.apache.lucene.search.Scorer}.
   * @lucene.internal
   */
  ...
  /**
   * Returns this searchers the top-level {@link org.apache.lucene.index.IndexReaderContext}.
   * @see org.apache.lucene.index.IndexReader#getContext()
   */
   ...
   * iterable interface to the completed {@link java.util.concurrent.Callable} instances.
   * 
   * @param <T>
   *          the type of the {@link java.util.concurrent.Callable} return value
   */
  ...
  /**
   * A class holding a subset of the {@link org.apache.lucene.search.IndexSearcher}s leaf contexts to be
