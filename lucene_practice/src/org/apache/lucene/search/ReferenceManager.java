 ...
 * recommended to consult the documentation of {@link org.apache.lucene.search.ReferenceManager}
...
public abstract class ReferenceManager<G> implements Closeable {
  ...
  /**
    ...
    * should be disposed or the application using the {@link org.apache.lucene.search.ReferenceManager}
    * is shutting down. The managed resource might not be released immediately,
    * if the {@link org.apache.lucene.search.ReferenceManager} user is holding on to a previously
    ...
    * resource on a closed {@link org.apache.lucene.search.ReferenceManager} will throw an
  ...
  /**
   * Remove a listener added with {@link #addListener(org.apache.lucene.search.ReferenceManager.RefreshListener)}.
   */
