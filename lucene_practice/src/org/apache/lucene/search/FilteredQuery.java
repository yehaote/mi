...
public class FilteredQuery extends Query {
   ...
   * {@link org.apache.lucene.search.Filter#getDocIdSet} will be called every time this query is used in a search.
   ...
   * 
   * @see org.apache.lucene.search.FilteredQuery.FilterStrategy
   */
  ...
  /** Returns this FilteredQuery's {@link org.apache.lucene.search.FilteredQuery.FilterStrategy} */
  ...
  /**
   * A {@link org.apache.lucene.search.FilteredQuery.FilterStrategy} that conditionally uses a random access filter if
   * the given {@link org.apache.lucene.search.DocIdSet} supports random access (returns a non-null value
   * from {@link org.apache.lucene.search.DocIdSet#bits()}) and
   * {@link org.apache.lucene.search.FilteredQuery.RandomAccessFilterStrategy#useRandomAccess(org.apache.lucene.util.Bits, int)} returns
   * <code>true</code>. Otherwise this strategy falls back to a "zig-zag join" (
   * {@link org.apache.lucene.search.FilteredQuery#LEAP_FROG_FILTER_FIRST_STRATEGY}) strategy.
   * 
   * <p>
   * Note: this strategy is the default strategy in {@link org.apache.lucene.search.FilteredQuery}
   * </p>
   */
  ...
  /**
   * A filter strategy that advances the Query or rather its {@link org.apache.lucene.search.Scorer} first and consults the
   * filter {@link org.apache.lucene.search.DocIdSet} for each matched document.
   * <p>
   * Note: this strategy requires a {@link org.apache.lucene.search.DocIdSet#bits()} to return a non-null value. Otherwise
   * this strategy falls back to {@link org.apache.lucene.search.FilteredQuery#LEAP_FROG_QUERY_FIRST_STRATEGY}
   * </p>
   * <p>
  ...
  /** Abstract class that defines how the filter ({@link org.apache.lucene.search.DocIdSet}) applied during document collection. */
  public static abstract class FilterStrategy {
    
    /**
     * Returns a filtered {@link org.apache.lucene.search.Scorer} based on this strategy.
     * 
     * @param context
     *          the {@link org.apache.lucene.index.AtomicReaderContext} for which to return the {@link org.apache.lucene.search.Scorer}.
     * @param scoreDocsInOrder
     *          specifies whether in-order scoring of documents is required. Note
     *          that if set to false (i.e., out-of-order scoring is required),
     *          this method can return whatever scoring mode it supports, as every
     *          in-order scorer is also an out-of-order one. However, an
     *          out-of-order scorer may not support {@link org.apache.lucene.search.Scorer#nextDoc()}
     *          and/or {@link org.apache.lucene.search.Scorer#advance(int)}, therefore it is recommended to
     *          request an in-order scorer if use of these methods is required.
     * @param topScorer
     *          if true, {@link org.apache.lucene.search.Scorer#score(org.apache.lucene.search.Collector)} will be called; if false,
     *          {@link org.apache.lucene.search.Scorer#nextDoc()} and/or {@link org.apache.lucene.search.Scorer#advance(int)} will
     *          be called.
     * @param weight the {@link org.apache.lucene.search.FilteredQuery} {@link org.apache.lucene.search.Weight} to create the filtered scorer.
     * @param docIdSet the filter {@link org.apache.lucene.search.DocIdSet} to apply
  ...
  /**
   * A filter strategy that advances the {@link org.apache.lucene.search.Scorer} first and consults the
   * {@link org.apache.lucene.search.DocIdSet} for each matched document.
   * <p>
   * Note: this strategy requires a {@link org.apache.lucene.search.DocIdSet#bits()} to return a non-null value. Otherwise
   * this strategy falls back to {@link org.apache.lucene.search.FilteredQuery#LEAP_FROG_QUERY_FIRST_STRATEGY}
   * </p>
