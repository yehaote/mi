 ...
 *
 * @since   lucene 1.4
 * @see org.apache.lucene.search.Sort
 */
public class SortField {
  ...
  public static enum Type {
    ...
    /** Force rewriting of SortField using {@link org.apache.lucene.search.SortField#rewrite(IndexSearcher)}
   ...
   *   org.apache.lucene.search.Sort}.  The comparator is primary if sortPos==0,
   ...
   * SortField is of type {@link org.apache.lucene.search.SortField.Type#REWRITEABLE}
   *
   * @param searcher IndexSearcher to use during rewriting
   * @return New rewritten SortField, or {@code this} if nothing has changed.
   * @throws java.io.IOException Can be thrown by the rewriting
   * @lucene.experimental
   */
