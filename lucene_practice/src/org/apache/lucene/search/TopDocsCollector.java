...
/**
 * A base class for all collectors that return a {@link org.apache.lucene.search.TopDocs} output. This
 * collector allows easy extension by providing a single constructor which
 * accepts a {@link org.apache.lucene.util.PriorityQueue} as well as protected members for that
 ...
 * passing null to {@link #TopDocsCollector(org.apache.lucene.util.PriorityQueue)}. In that case
...
public abstract class TopDocsCollector<T extends ScoreDoc> extends Collector {
  ...
  /**
   * Returns a {@link org.apache.lucene.search.TopDocs} instance containing the given results. If
   ...
   * with the returned {@link org.apache.lucene.search.TopDocs} object, which will contain all the
   ...
   * returned {@link org.apache.lucene.search.TopDocs} object, which will contain all the results this
