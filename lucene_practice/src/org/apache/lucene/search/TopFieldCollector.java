...
/**
 * A {@link org.apache.lucene.search.Collector} that sorts by {@link org.apache.lucene.search.SortField} using
 * {@link org.apache.lucene.search.FieldComparator}s.
 * <p/>
...
public abstract class TopFieldCollector extends TopDocsCollector<Entry> {
  ...
  /**
   * Creates a new {@link org.apache.lucene.search.TopFieldCollector} from the given
   * arguments.
   *
   ...
   *          the given {@link org.apache.lucene.search.Scorer} in {@link #setScorer(org.apache.lucene.search.Scorer)}.
   * @return a {@link org.apache.lucene.search.TopFieldCollector} instance which will sort the results by
   *         the sort criteria.
