...
/**
 * A range filter built on top of a cached single term field (in {@link org.apache.lucene.search.FieldCache}).
 * 
 ...
 * as building a {@link org.apache.lucene.search.TermRangeFilter}, if using a {@link #newStringRange}.
 * However, if the range never changes it is slower (around 2x as slow) than building
 * a CachingWrapperFilter on top of a single {@link org.apache.lucene.search.TermRangeFilter}.
 *
 * For numeric data types, this filter may be significantly faster than {@link org.apache.lucene.search.NumericRangeFilter}.
 ...
 *
 * <p>As with all {@link org.apache.lucene.search.FieldCache} based functionality, {@code FieldCacheRangeFilter} is only valid for
 * fields which exact one term for each document (except for {@link #newStringRange}
 * where 0 terms are also allowed). Due to a restriction of {@link org.apache.lucene.search.FieldCache}, for numeric ranges
 ...
 * that create a correct instance for different data types supported by {@link org.apache.lucene.search.FieldCache}.
 */
...
public abstract class FieldCacheRangeFilter<T> extends Filter {
  ...
  /**
   * Creates a string range filter using {@link org.apache.lucene.search.FieldCache#getTermsIndex}. This works with all
  ...
  /**
   * Creates a BytesRef range filter using {@link org.apache.lucene.search.FieldCache#getTermsIndex}. This works with all
   * fields containing zero or one term in the field. The range can be half-open by setting one
   * of the values to <code>null</code>.
   */
  ...
  /**
   * Creates a numeric range filter using {@link org.apache.lucene.search.FieldCache#getBytes(org.apache.lucene.index.AtomicReader,String,boolean)}. This works with all
  ...
  /**
   * Creates a numeric range filter using {@link org.apache.lucene.search.FieldCache#getBytes(org.apache.lucene.index.AtomicReader,String, org.apache.lucene.search.FieldCache.ByteParser,boolean)}. This works with all
   * byte fields containing exactly one numeric term in the field. The range can be half-open by setting one
   * of the values to <code>null</code>.
   */
  ...
  /**
   * Creates a numeric range filter using {@link org.apache.lucene.search.FieldCache#getShorts(org.apache.lucene.index.AtomicReader,String,boolean)}. This works with all
  ...
  /**
   * Creates a numeric range filter using {@link org.apache.lucene.search.FieldCache#getShorts(org.apache.lucene.index.AtomicReader,String, org.apache.lucene.search.FieldCache.ShortParser,boolean)}. This works with all
   * short fields containing exactly one numeric term in the field. The range can be half-open by setting one
   * of the values to <code>null</code>.
   */
  ...
  /**
   * Creates a numeric range filter using {@link org.apache.lucene.search.FieldCache#getInts(org.apache.lucene.index.AtomicReader,String,boolean)}. This works with all
  ...
  /**
   * Creates a numeric range filter using {@link org.apache.lucene.search.FieldCache#getInts(org.apache.lucene.index.AtomicReader,String, org.apache.lucene.search.FieldCache.IntParser,boolean)}. This works with all
   * int fields containing exactly one numeric term in the field. The range can be half-open by setting one
   * of the values to <code>null</code>.
   */
  ...
  /**
   * Creates a numeric range filter using {@link org.apache.lucene.search.FieldCache#getLongs(org.apache.lucene.index.AtomicReader,String,boolean)}. This works with all
  ...
  /**
   * Creates a numeric range filter using {@link org.apache.lucene.search.FieldCache#getLongs(org.apache.lucene.index.AtomicReader,String, org.apache.lucene.search.FieldCache.LongParser,boolean)}. This works with all
   * long fields containing exactly one numeric term in the field. The range can be half-open by setting one
   * of the values to <code>null</code>.
   */
  ...
  /**
   * Creates a numeric range filter using {@link org.apache.lucene.search.FieldCache#getFloats(org.apache.lucene.index.AtomicReader,String,boolean)}. This works with all
  ...
  /**
   * Creates a numeric range filter using {@link org.apache.lucene.search.FieldCache#getFloats(org.apache.lucene.index.AtomicReader,String, org.apache.lucene.search.FieldCache.FloatParser,boolean)}. This works with all
   * float fields containing exactly one numeric term in the field. The range can be half-open by setting one
   * of the values to <code>null</code>.
   */
  ...
  /**
   * Creates a numeric range filter using {@link org.apache.lucene.search.FieldCache#getDoubles(org.apache.lucene.index.AtomicReader,String,boolean)}. This works with all
  ...
  /**
   * Creates a numeric range filter using {@link org.apache.lucene.search.FieldCache#getDoubles(org.apache.lucene.index.AtomicReader,String, org.apache.lucene.search.FieldCache.DoubleParser,boolean)}. This works with all
   * double fields containing exactly one numeric term in the field. The range can be half-open by setting one
   * of the values to <code>null</code>.
   */
